/*!
 * Site interactions – nav, sliders, and UI animations (legacy runtime).
 * @license MIT
 * Inline scripts may use: var Webflow = Webflow || []; Webflow.push(readyFunction);
 */
...
(() => {
    ...
    (function () {
      ...
      let n = function (s) {
        ...
        o = function (s) {
          ...
          for (let m in d)
            c.getPropertyValue(m) !== d[m] && (s.style[m] = d[m]);
        },
        i = function (s) {
          let c = s.parentNode;
          (n(c),
  ...
  var Bi = u(() => {
    window.tram = (function (e) {
      ...
      function o(l, b, w) {
        return (
          '#' + ((1 << 24) | (l << 16) | (b << 8) | w).toString(16).slice(1)
        );
      }
      function i() {}
      function a(l, b) {
        d('Type warning: Expected: [' + l + '] Got: [' + typeof b + '] ' + b);
      }
      function s(l, b, w) {
        d('Units do not match [' + l + ']: ' + b + ', ' + w);
      }
      function c(l, b, w) {
        if ((b !== void 0 && (w = b), l === void 0)) return w;
        var x = w;
        return (
          Fe.test(l) || !Be.test(l)
            ? (x = parseInt(l, 10))
            : Be.test(l) && (x = 1e3 * parseFloat(l)),
          0 > x && (x = 0),
          x === x ? x : w
        );
      }
      ...
      function m(l) {
        for (var b = -1, w = l ? l.length : 0, x = []; ++b < w; ) {
          var D = l[b];
          D && x.push(D);
        }
        return x;
      }
      var f = (function (l, b, w) {
          function x(ie) {
          ...
          function J(ie, Ie) {
            function H() {
              var Ge = new le();
              return (D(Ge.init) && Ge.init.apply(Ge, arguments), Ge);
            }
            function le() {}
            (Ie === w && ((Ie = ie), (ie = Object)), (H.Bare = le));
            var de,
              Ae = (M[l] = ie[l]),
              ut = (le[l] = H[l] = new M());
            return (
              (ut.constructor = H),
              (H.mixin = function (Ge) {
                return ((le[l] = H[l] = J(H, Ge)[l]), H);
              }),
              (H.open = function (Ge) {
                if (
                  ((de = {}),
                  D(Ge) ? (de = Ge.call(H, ut, Ae, H, ie)) : x(Ge) && (de = Ge),
                  x(de))
                )
                  for (var Sr in de) b.call(de, Sr) && (ut[Sr] = de[Sr]);
                return (D(ut.init) || (ut.init = ie), H);
              }),
              H.open(Ie)
            );
          }
        ...
        T = {
          ease: [
            ...
            function (l, b, w, x) {
              ...
              return (
                b +
                w * (-2.75 * M * D + 11 * D * D + -15.5 * M + 8 * D + 0.25 * l)
              );
            },
          ],
          'ease-in': [
            ...
            function (l, b, w, x) {
              var D = (l /= x) * l,
                M = D * l;
              return b + w * (-1 * M * D + 3 * D * D + -3 * M + 2 * D);
            },
          ],
          'ease-out': [
            'ease-out',
            function (l, b, w, x) {
              ...
              return (
                b +
                w * (0.3 * M * D + -1.6 * D * D + 2.2 * M + -1.8 * D + 1.9 * l)
              );
            },
          ],
          'ease-in-out': [
            ...
            function (l, b, w, x) {
              var D = (l /= x) * l,
                M = D * l;
              return b + w * (2 * M * D + -5 * D * D + 2 * M + 2 * D);
            },
          ],
          linear: [
            'linear',
          ...
          'ease-in-quart': [
            ...
            function (l, b, w, x) {
              return w * (l /= x) * l * l * l + b;
            },
          ],
          'ease-out-quart': [
            'cubic-bezier(0.165, 0.840, 0.440, 1)',
            function (l, b, w, x) {
              return -w * ((l = l / x - 1) * l * l * l - 1) + b;
            },
          ],
          'ease-in-out-quart': [
          ...
          'ease-in-quint': [
            ...
            function (l, b, w, x) {
              return w * (l /= x) * l * l * l * l + b;
            },
          ],
          'ease-out-quint': [
            'cubic-bezier(0.230, 1, 0.320, 1)',
            function (l, b, w, x) {
              return w * ((l = l / x - 1) * l * l * l * l + 1) + b;
            },
          ],
          'ease-in-out-quint': [
          ...
          'ease-in-sine': [
            ...
            function (l, b, w, x) {
              return -w * Math.cos((l / x) * (Math.PI / 2)) + w + b;
            },
          ],
          'ease-out-sine': [
            'cubic-bezier(0.390, 0.575, 0.565, 1)',
            function (l, b, w, x) {
              return w * Math.sin((l / x) * (Math.PI / 2)) + b;
            },
          ],
          'ease-in-out-sine': [
            'cubic-bezier(0.445, 0.050, 0.550, 0.950)',
            function (l, b, w, x) {
              return (-w / 2) * (Math.cos((Math.PI * l) / x) - 1) + b;
            },
          ],
          'ease-in-expo': [
            'cubic-bezier(0.950, 0.050, 0.795, 0.035)',
            function (l, b, w, x) {
              return l === 0 ? b : w * Math.pow(2, 10 * (l / x - 1)) + b;
            },
          ],
          'ease-out-expo': [
            ...
            function (l, b, w, x) {
              return l === 0
                ...
                : l === x
                  ? b + w
                  : (l /= x / 2) < 1
                    ? (w / 2) * Math.pow(2, 10 * (l - 1)) + b
                    : (w / 2) * (-Math.pow(2, -10 * --l) + 2) + b;
            },
          ],
          'ease-in-circ': [
            'cubic-bezier(0.600, 0.040, 0.980, 0.335)',
            function (l, b, w, x) {
              return -w * (Math.sqrt(1 - (l /= x) * l) - 1) + b;
            },
          ],
          'ease-out-circ': [
            'cubic-bezier(0.075, 0.820, 0.165, 1)',
            function (l, b, w, x) {
              return w * Math.sqrt(1 - (l = l / x - 1) * l) + b;
            },
          ],
          'ease-in-out-circ': [
            ...
            function (l, b, w, x) {
              return (l /= x / 2) < 1
                ? (-w / 2) * (Math.sqrt(1 - l * l) - 1) + b
                : (w / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + b;
            },
          ],
          'ease-in-back': [
        ...
        S = function (l) {
          ...
          for (b = 0; b < D.length; b++)
            x += D[b].charAt(0).toUpperCase() + D[b].slice(1);
          for (b = 0; b < h.length; b++)
            if (((w = h[b] + x), w in N.style))
              return { dom: w, css: P[b] + l };
        },
        F = (t.support = {
      ...
      if (F.transition) {
        var j = F.timing.dom;
        if (((N.style[j] = T['ease-in-back'][0]), !N.style[j]))
          for (var Z in E) T[Z][0] = E[Z];
      }
      var fe = (t.frame = (function () {
          var l =
        ...
        _ = f(function (l) {
          function b(ee, pe) {
            ...
            pe = pe || {};
            var Xe = k[ge];
            if (!Xe) return d('Unsupported property: ' + ge);
            if (!pe.weak || !this.props[ge]) {
              var Ze = Xe[0],
                ke = this.props[ge];
              return (
                ke || (ke = this.props[ge] = new Ze.Bare()),
                ke.init(this.$el, be, Xe, pe),
                ke
              );
            }
          }
              ...
              if (ge == 'string' && pe) {
                switch (ee) {
                  ...
                  case 'redraw':
                    ...
                    break;
                  default:
                    b.call(this, ee, be && be[1]);
                }
                return M.call(this);
              }
              if (ge == 'function') return void ee.call(this, this);
              if (ge == 'object') {
                var Xe = 0;
                (ut.call(
                  this,
                  ee,
                  function (Se, wm) {
                    (Se.span > Xe && (Xe = Se.span), Se.stop(), Se.animate(wm));
                  },
                  function (Se) {
                  ...
                  Xe > 0 &&
                    ...
                    (this.active = !0),
                    pe && (this.timer.complete = M)));
                var Ze = this,
                  ke = !1,
                  pn = {};
                fe(function () {
                  (ut.call(Ze, ee, function (Se) {
          ...
          function J(ee) {
            ...
            (typeof ee == 'string'
              ? ((pe = {}), (pe[ee] = 1))
              : (pe = typeof ee == 'object' && ee != null ? ee : this.props),
              ut.call(this, pe, Ge),
              Ae.call(this));
          }
          function ie(ee) {
            (J.call(this, ee), ut.call(this, ee, Sr, bm));
          }
          function Ie(ee) {
          ...
          function Ae() {
            ...
            for (ee in this.props)
              ((pe = this.props[ee]), pe.active && be.push(pe.string));
            ((be = be.join(',')),
              this.style !== be &&
                ((this.style = be), (this.el.style[F.transition.dom] = be)));
          }
          function ut(ee, pe, be) {
            var ge,
              Xe,
              Ze,
              ke,
                ...
                ge in ve
                  ...
                  : (q.test(ge) && (ge = r(ge)),
                    ge in k
                      ...
                      : (ke || (ke = {}), (ke[ge] = Ze))));
            for (ge in Se) {
              if (((Ze = Se[ge]), (Xe = this.props[ge]), !Xe)) {
                if (!pn) continue;
                Xe = b.call(this, ge);
              }
              pe.call(this, Xe, Ze);
          ...
          function Om(ee, pe) {
            ...
            for (be = 0; ge > be; be++) ee.apply(this.children[be], pe);
            return this;
          }
          ((l.init = function (ee) {
            if (
        ...
        p = f(_, function (l) {
          function b(w, x) {
            var D = e.data(w, C) || e.data(w, C, new _.Bare());
            return (D.el || D.init(w), x ? D.start(x) : D);
          }
          l.init = function (w, x) {
            var D = e(w);
            if (!D.length) return this;
            if (D.length === 1) return b(D[0], x);
            var M = [];
            return (
              D.each(function (J, ie) {
                M.push(b(ie, x));
              }),
              (this.children = M),
              this
        ...
        v = f(function (l) {
          ...
          function w(M, J, ie) {
            return (J !== void 0 && (ie = J), M in T ? M : ie);
          }
          function x(M) {
            var J = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(M);
            return (J ? o(J[1], J[2], J[3]) : M).replace(
              /#(\w)(\w)(\w)$/,
              '#$1$1$2$2$3$3'
            );
          }
          var D = { duration: 500, ease: 'ease', delay: 0 };
          ((l.init = function (M, J, ie, Ie) {
            ...
            (ie[2] && (H = ie[2]),
              ...
              (this.name = H),
              (this.type = ie[1]),
              (this.duration = c(J[1], this.duration, D.duration)),
              (this.ease = w(J[2], this.ease, D.ease)),
              (this.delay = c(J[3], this.delay, D.delay)),
              (this.span = this.duration + this.delay),
              (this.active = !1),
              (this.nextStyle = null),
              (this.auto = te.test(this.name)),
              (this.unit = Ie.unit || this.unit || ne.defaultUnit),
              (this.angle = Ie.angle || this.angle || ne.defaultAngle),
              ne.fallback || Ie.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    'ms' +
                    (this.ease != 'ease' ? U + T[this.ease][0] : '') +
              ...
              switch (J) {
                ...
                case X:
                  if (H) {
                    ...
                    if (J.test(M))
                      return M.charAt(0) == '#' && M.length == 7 ? M : x(M);
                  }
                  ie = 'hex or rgb string';
                  break;
                case V:
                  if (Ie) return M + this.unit;
                  if (H && J.test(M)) return M;
                ...
                case G:
                  ...
                  break;
                case B:
                  if (Ie) return M + this.angle;
                  if (H && J.test(M)) return M;
                  ie = 'number(deg) or string(angle)';
                  break;
                case K:
                  if (Ie || (H && G.test(M))) return M;
        ...
        re = f(v, function (l, b) {
          ...
          ((l.init = function () {
            ...
            (l.transition = function (x) {
              ...
              var M,
                J = {};
              for (M in this.current) J[M] = M in D ? D[M] : this.current[M];
            ...
            (l.values = function (x) {
              var D,
                M = {};
              return (
                w.call(this, x, function (J, ie, Ie) {
                  ((M[J] = ie),
                    this.current[J] === void 0 &&
                      ((D = 0),
                      ~J.indexOf('scale') && (D = 1),
                      (this.current[J] = this.convert(D, Ie))));
                }),
                M
              );
            }));
        ...
        he = f(function (l) {
          ...
          function w() {
            var H,
              ...
              Ae = ie.length;
            if (Ae)
              for (fe(w), le = ce(), H = Ae; H--; )
                ((de = ie[H]), de && de.render(le));
          }
          function x(H) {
            var le,
              de = e.inArray(H, ie);
          ...
          var J = { ease: T.ease[1], from: 0, to: 1 };
          ((l.init = function (H) {
            ...
            (l.render = function (H) {
              ...
              if (de < this.duration) {
                ...
                return (
                  (le = this.startRGB
                    ? M(this.startRGB, this.endRGB, Ae)
                    : D(this.begin + Ae * this.change)),
            ...
            (l.format = function (H, le) {
              ...
              if (!this.unit) {
                var de = le.replace(R, ''),
                  Ae = H.replace(R, '');
                (de !== Ae && s('tween', le, H), (this.unit = de));
              }
              ((le = parseFloat(le)),
                (H = parseFloat(H)),
          ...
          ((l.init = function (w) {
            ...
            (l.render = function (w) {
              ...
              for (x = M; x--; )
                ((D = this.tweens[x]),
                  D.context &&
                    (D.render(w), (this.current[D.name] = D.value), (J = !0)));
              return J
      ...
      ((t.fallback = function (l) {
        ...
        (t.delay = function (l, b, w) {
          return new ue({ complete: b, duration: l, context: w });
        }),
    ...
    xs.exports = (function () {
      ...
      var t = {},
        ...
        G =
          ...
          e.forEach =
            function (h, P, S) {
              if (h == null) return h;
              if (m && h.forEach === m) h.forEach(P, S);
              else if (h.length === +h.length) {
                for (var F = 0, j = h.length; F < j; F++)
                  if (P.call(S, h[F], F, h) === t) return;
              } else
                for (var Z = e.keys(h), F = 0, j = Z.length; F < j; F++)
                  if (P.call(S, h[Z[F]], Z[F], h) === t) return;
              return h;
            });
      ((e.map = e.collect =
        function (h, P, S) {
        ...
        (e.find = e.detect =
          function (h, P, S) {
            ...
            return (
              B(h, function (j, Z, fe) {
                if (P.call(S, j, Z, fe)) return ((F = j), !0);
              }),
              F
            );
          }),
          ...
          function (h, P, S) {
            ...
            return h == null
              ...
              : C && h.some === C
                ? h.some(P, S)
                : (G(h, function (j, Z, fe) {
                    if (F || (F = P.call(S, j, Z, fe))) return t;
                  }),
                  !!F);
          });
      ((e.contains = e.include =
        ...
        (e.debounce = function (h, P, S) {
          var F,
            ...
            _ = function () {
              ...
              p < P
                ? (F = setTimeout(_, P - p))
                : ((F = null), S || ((ce = h.apply(Z, j)), (Z = j = null)));
            };
          return function () {
            ((Z = this), (j = arguments), (fe = e.now()));
            var p = S && !F;
            return (
              F || (F = setTimeout(_, P)),
              p && ((ce = h.apply(Z, j)), (Z = j = null)),
              ce
            );
          };
        }),
        (e.defaults = function (h) {
          ...
          for (var P = 1, S = arguments.length; P < S; P++) {
            var F = arguments[P];
            for (var j in F) h[j] === void 0 && (h[j] = F[j]);
          }
          return h;
        }),
        (e.keys = function (h) {
          ...
          if (X) return X(h);
          var P = [];
          for (var S in h) e.has(h, S) && P.push(S);
          return P;
        }),
        (e.has = function (h, P) {
          return d.call(h, P);
      ...
      var K = /(.)^/,
        ...
        N = /^\s*(\w|\$)+\s*$/;
      return (
        (e.template = function (h, P, S) {
          (!P && S && (P = S), (P = e.defaults({}, P, e.templateSettings)));
          var F = RegExp(
              [
                (P.escape || K).source,
            ...
            j = 0,
            Z = "__p+='";
          (h.replace(F, function (p, v, y, Q, re) {
            return (
              (Z += h.slice(j, re).replace(te, U)),
              (j = re + p.length),
              v
                ? (Z +=
                    `'+
...
`));
          ...
          if (fe) {
            if (!N.test(fe))
              throw new Error('variable is not a bare identifier: ' + fe);
          } else
            ((Z =
              `with(obj||{}){
` +
...
`;
          var ce;
          try {
            ce = new Function(P.variable || 'obj', '_', Z);
          } catch (p) {
            throw ((p.source = Z), p);
          }
          var _ = function (p) {
            return ce.call(this, p, e);
          };
          return (
            (_.source =
              'function(' +
...
` +
  ...
  var ze = u((HW, Gs) => {
    ...
    var vn = navigator.userAgent.toLowerCase(),
      ...
      qm = (Ee.env.ios = /(ipod|iphone|ipad)/.test(vn));
    Ee.env.safari = /safari/.test(vn) && !Nm && !qm;
    var ki;
    Ds &&
    ...
    Ee.ready = function () {
      ((hn = !0), ji ? Pm() : Je.each($t, Ns), Je.each(Hi, Ns), Ee.resize.up());
    };
    function Ns(e) {
      ct(e) && e();
    }
  ...
  var Us = u((jW, Vs) => {
    ...
    Xs.define(
      ...
      (Vs.exports = function (e) {
        ...
        function f() {
          var E = e('<a class="site-badge"></a>').attr(
              'href',
        ...
        function T() {
          var E = o.children(i),
            I = E.length && E.get(0) === d,
            O = Xs.env('editor');
          if (I) {
            O && E.remove();
            return;
          }
          (E.length && E.remove(), O || o.append(d));
        }
        return t;
      })
    );
        ...
        function e(r) {
          ...
          function c(A) {
            var X = A.type,
              V = A.tagName;
            return !!(
              (V === 'INPUT' && a[X] && !A.readOnly) ||
              (V === 'TEXTAREA' && !A.readOnly) ||
              A.isContentEditable
            );
          }
          function d(A) {
  ...
  var Ys = u((YW, zs) => {
    ...
    var zi = window.jQuery,
      ...
      En = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), zi(t).triggerHandler(lt.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), zi(t).triggerHandler(lt.types.OUTRO));
        },
      };
    lt.triggers = {};
  ...
  var Rr = u((QW, Zs) => {
    ...
    var Mm = window.jQuery,
      ...
      Fm = {
        ...
        intro: function (e, t) {
          (Yi.triggers.intro(e, t), Qs(t, 'COMPONENT_ACTIVE'));
        },
        outro: function (e, t) {
          (Yi.triggers.outro(e, t), Qs(t, 'COMPONENT_INACTIVE'));
        },
      };
    _n.triggers = {};
    _n.types = { INTRO: 'w-ix-intro' + $s, OUTRO: 'w-ix-outro' + $s };
    Mm.extend(_n.triggers, Fm);
    Zs.exports = _n;
  });
  var Js = u(($W, yt) => {
    function Qi(e) {
  ...
  var Gt = u((ZW, xr) => {
    ...
    function Xm(e, t) {
      ...
      if (e === null || (Gm(e) !== 'object' && typeof e != 'function'))
        return { default: e };
      var r = eu(t);
  ...
  var bu = u((vB, Tu) => {
    var iI = rt();
    Tu.exports = iI({}.isPrototypeOf);
  });
  var wu = u((hB, Ou) => {
    var oI = Lr();
    Ou.exports = oI('navigator', 'userAgent') || '';
  });
  var qu = u((gB, Nu) => {
    var Cu = Te(),
      no = wu(),
      Au = Cu.process,
      Su = Cu.Deno,
      Ru = (Au && Au.versions) || (Su && Su.version),
      xu = Ru && Ru.v8,
      nt,
      In;
    xu &&
      ((nt = xu.split('.')),
      (In = nt[0] > 0 && nt[0] < 4 ? 1 : +(nt[0] + nt[1])));
    !In &&
      no &&
      ((nt = no.match(/Edge\/(\d+)/)),
      (!nt || nt[1] >= 74) &&
        ((nt = no.match(/Chrome\/(\d+)/)), nt && (In = +nt[1])));
    Nu.exports = In;
  });
  var io = u((EB, Pu) => {
    var Lu = qu(),
  ...
  var oo = u((_B, Du) => {
    var sI = io();
    Du.exports = sI && !Symbol.sham && typeof Symbol.iterator == 'symbol';
  });
  var ao = u((yB, Mu) => {
    var uI = Te(),
      cI = Lr(),
  ...
  var Tn = u((wB, zu) => {
    ...
    zu.exports = function (e, t) {
      try {
        bI(Ku, e, { value: t, configurable: !0, writable: !0 });
      } catch {
        Ku[e] = t;
      }
      return t;
  ...
  var po = u((NB, sc) => {
    var GI = Te(),
      ...
      Vt = GI.Symbol,
      oc = Vt && Vt.for,
      UI = ac ? Vt : (Vt && Vt.withoutSetter) || VI;
  ...
  var fc = u((qB, lc) => {
    ...
    lc.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = 'default'), (n = BI(r, e, t)), !uc(n) || cc(n))
        )
          return n;
  ...
  var mo = u((VB, Oc) => {
    var IT = rt(),
      TT = ft(),
      yo = bn(),
      bT = IT(Function.toString);
    TT(yo.inspectSource) ||
      (yo.inspectSource = function (e) {
        return bT(e);
      });
    Oc.exports = yo.inspectSource;
  });
  var Sc = u((UB, Ac) => {
    var OT = Te(),
      wT = ft(),
      AT = mo(),
      wc = OT.WeakMap;
    Ac.exports = wT(wc) && /native code/.test(AT(wc));
  });
  var Io = u((WB, xc) => {
    var ST = lo(),
      RT = fo(),
  ...
  var Mc = u((kB, Dc) => {
    ...
    xT || Oo.state
      ...
      : ((Ut = qT('state')),
        (LT[Ut] = !0),
        (An = function (e, t) {
          if (bo(e, Ut)) throw new Ao(Nc);
          return ((t.facade = e), NT(e, Ut, t), t);
        }),
        (Mr = function (e) {
          return bo(e, Ut) ? e[Ut] : {};
        }),
    ...
    var At, qc, wo, Lc, Ut;
    Dc.exports = { set: An, get: Mr, has: Sn, enforce: DT, getterFor: MT };
  });
  var Xc = u((HB, Gc) => {
    var So = Xt(),
      FT = wt(),
      Fc = Function.prototype,
      GT = So && Object.getOwnPropertyDescriptor,
      Ro = FT(Fc, 'name'),
      XT = Ro && function () {}.name === 'something',
      VT = Ro && (!So || (So && GT(Fc, 'name').configurable));
    Gc.exports = { EXISTS: Ro, PROPER: XT, CONFIGURABLE: VT };
  });
  var kc = u((jB, Bc) => {
    var UT = Te(),
      Vc = ft(),
    ...
    (Bc.exports = function (e, t, r, n) {
      ...
      if (
        (Vc(r) &&
          ...
          (!WT(r, 'name') || (HT && r.name !== s)) && Uc(r, 'name', s),
          (c = KT(r)),
          c.source || (c.source = zT.join(typeof s == 'string' ? s : ''))),
        e === UT)
      ) {
        i ? (e[t] = r) : BT(t, r);
        return;
      ...
      return (Vc(this) && jT(this).source) || kT(this);
    });
  });
  var xo = u((KB, Hc) => {
    var YT = Math.ceil,
  ...
  var Yc = u((YB, zc) => {
    ...
    zc.exports = function (e) {
      return e > 0 ? tb(eb(e), 9007199254740991) : 0;
    };
  });
  var $c = u((QB, Qc) => {
    var rb = Yc();
  ...
  var qo = u((ZB, tl) => {
    ...
    tl.exports = function (e, t) {
      var r = sb(e),
        ...
        o = [],
        i;
      for (i in r) !No(cb, i) && No(r, i) && el(o, i);
      for (; t.length > n; ) No(r, (i = t[n++])) && (~ub(o, i) || el(o, i));
      return o;
    };
  });
  var Rn = u((JB, rl) => {
  ...
  var ll = u((nk, cl) => {
    ...
    cl.exports = function (e, t) {
      for (var r = mb(t), n = Tb.f, o = Ib.f, i = 0; i < r.length; i++) {
        var a = r[i];
        yb(e, a) || n(e, a, o(t, a));
      }
    };
  ...
  var dl = u((ik, fl) => {
    var bb = Zt(),
      ...
      Fr = function (e, t) {
        var r = Sb[Ab(e)];
        return r == xb ? !0 : r == Rb ? !1 : Ob(t) ? bb(t) : !!t;
      },
      Ab = (Fr.normalize = function (e) {
    ...
    pl.exports = function (e, t) {
      ...
      if (
        ...
        for (s in t) {
          if (
            ((d = t[s]),
            e.noTargetGet ? ((m = Cb(a, s)), (c = m && m.value)) : (c = a[s]),
            (i = Db(n ? s : r + (o ? '.' : '#') + s, e.forced)),
            !i && c !== void 0)
          ) {
            if (typeof d == typeof c) continue;
            Pb(d, c);
          }
          ((e.sham || (c && c.sham)) && Nb(d, 'sham', !0), qb(a, s, d, e));
        }
    };
  });
  var gl = u((ak, hl) => {
  ...
  var _l = u((sk, El) => {
    ...
    El.exports = Gb
      ...
      : function (t, r) {
          Vb(t);
          for (var n = Ub(r), o = Wb(r), i = o.length, a = 0, s; i > a; )
            Xb.f(t, (s = o[a++]), n[s]);
          return t;
        };
  });
  var ml = u((uk, yl) => {
    var Bb = Lr();
    yl.exports = Bb('document', 'documentElement');
  });
  var Rl = u((ck, Sl) => {
    var kb = Pr(),
      Hb = _l(),
        ...
        Cn =
          typeof document < 'u'
            ? document.domain && xn
              ...
              : Qb()
            : Ol(xn);
        for (var e = Il.length; e--; ) delete Cn[Do][Il[e]];
        return Cn();
      };
    jb[wl] = !0;
    Sl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((Po[Do] = kb(t)), (n = new Po()), (Po[Do] = null), (n[wl] = t))
            : (n = Cn()),
          r === void 0 ? n : Hb(n, r)
        );
      };
  ...
  var Cl = u((lk, xl) => {
    var $b = po(),
      ...
      Fo = $b('unscopables'),
      Go = Array.prototype;
    Go[Fo] == null && Jb.f(Go, Fo, { configurable: !0, value: Zb(null) });
  ...
  var Ll = u((pk, ql) => {
    ...
    ql.exports = function (e, t) {
      return iO(nO[e].prototype[t]);
    };
  });
  var Dl = u((vk, Pl) => {
    Nl();
    var oO = Ll();
    Pl.exports = oO('Array', 'includes');
  });
  var Fl = u((hk, Ml) => {
    var aO = Dl();
    Ml.exports = aO;
  ...
  var Uo = u((Ok, Jl) => {
    var AO = Vo(),
      SO = AO(Object.getPrototypeOf, Object);
    Jl.exports = SO;
  });
  var mt = u((wk, ef) => {
    function RO(e) {
  ...
  var Wo = u((Ak, rf) => {
    var xO = St(),
      ...
      PO = Object.prototype,
      tf = LO.toString,
      DO = PO.hasOwnProperty,
      MO = tf.call(Object);
    function FO(e) {
      if (!NO(e) || xO(e) != qO) return !1;
      var t = CO(e);
      if (t === null) return !0;
      var r = DO.call(t, 'constructor') && t.constructor;
      return typeof r == 'function' && r instanceof r && tf.call(r) == MO;
    }
    rf.exports = FO;
  });
  var nf = u((Bo) => {
  ...
  var jo = u((Xr) => {
    ...
    function cf(e, t, r) {
      ...
      return (
        T({ type: sf.INIT }),
        (n = { dispatch: T, subscribe: f, getState: m, replaceReducer: E }),
        (n[af.default] = I),
        n
      );
    }
  ...
  var df = u((Yo) => {
    ...
    function $O(e) {
      ...
      return function () {
        ...
        if (s) throw s;
        if (!1) var f;
        for (var T = !1, E = {}, I = 0; I < i.length; I++) {
          var O = i[I],
            C = r[O],
            R = d[O],
            q = C(R, m);
      ...
      return function (n) {
        return function (o, i, a) {
          ...
          return (
            ...
            (c = rw.default.apply(void 0, d)(s.dispatch)),
            ew({}, s, { dispatch: c })
          );
        };
      };
  ...
  var ea = u((Ye) => {
    ...
    Ye.createStore = aw.default;
    Ye.combineReducers = uw.default;
    Ye.bindActionCreators = lw.default;
    Ye.applyMiddleware = dw.default;
    Ye.compose = vw.default;
  });
  var gf = u((Ne) => {
    'use strict';
    ...
    Ne.EventTypeConsts = gw;
    var Ew = { ELEMENT: 'ELEMENT', CLASS: 'CLASS', PAGE: 'PAGE' };
    Ne.EventAppliesTo = Ew;
    var _w = { ELEMENT: 'ELEMENT', VIEWPORT: 'VIEWPORT' };
    Ne.EventBasedOn = _w;
    var yw = { X_AXIS: 'X_AXIS', Y_AXIS: 'Y_AXIS' };
    Ne.EventContinuousMouseAxes = yw;
    var mw = {
      CHILDREN: 'CHILDREN',
      SIBLINGS: 'SIBLINGS',
    ...
    Ne.QuickEffectDirectionConsts = Tw;
  });
  var ta = u((ir) => {
    'use strict';
    ...
    ir.ActionTypeConsts = bw;
    var Ow = {
      ELEMENT: 'ELEMENT',
      ELEMENT_CLASS: 'ELEMENT_CLASS',
      TRIGGER_ELEMENT: 'TRIGGER_ELEMENT',
    };
    ir.ActionAppliesTo = Ow;
  });
  var Ef = u((Nn) => {
    'use strict';
  ...
  var _f = u((qn) => {
    ...
    qn.ReducedMotionTypes = Pw;
  });
  var yf = u((ae) => {
    'use strict';
    Object.defineProperty(ae, '__esModule', { value: !0 });
    ae.IX2_VIEWPORT_WIDTH_CHANGED =
      ae.IX2_TEST_FRAME_RENDERED =
      ae.IX2_STOP_REQUESTED =
      ae.IX2_SESSION_STOPPED =
      ae.IX2_SESSION_STARTED =
      ae.IX2_SESSION_INITIALIZED =
      ae.IX2_RAW_DATA_IMPORTED =
      ae.IX2_PREVIEW_REQUESTED =
      ae.IX2_PLAYBACK_REQUESTED =
      ae.IX2_PARAMETER_CHANGED =
      ae.IX2_MEDIA_QUERIES_DEFINED =
      ae.IX2_INSTANCE_STARTED =
      ae.IX2_INSTANCE_REMOVED =
      ae.IX2_INSTANCE_ADDED =
      ae.IX2_EVENT_STATE_CHANGED =
      ae.IX2_EVENT_LISTENER_ADDED =
      ae.IX2_ELEMENT_STATE_CHANGED =
      ae.IX2_CLEAR_REQUESTED =
      ae.IX2_ANIMATION_FRAME_CHANGED =
      ae.IX2_ACTION_LIST_PLAYBACK_CHANGED =
        void 0;
    var Dw = 'IX2_RAW_DATA_IMPORTED';
    ae.IX2_RAW_DATA_IMPORTED = Dw;
    var Mw = 'IX2_SESSION_INITIALIZED';
    ae.IX2_SESSION_INITIALIZED = Mw;
    var Fw = 'IX2_SESSION_STARTED';
    ae.IX2_SESSION_STARTED = Fw;
    var Gw = 'IX2_SESSION_STOPPED';
    ae.IX2_SESSION_STOPPED = Gw;
    var Xw = 'IX2_PREVIEW_REQUESTED';
    ae.IX2_PREVIEW_REQUESTED = Xw;
    var Vw = 'IX2_PLAYBACK_REQUESTED';
    ae.IX2_PLAYBACK_REQUESTED = Vw;
    var Uw = 'IX2_STOP_REQUESTED';
    ae.IX2_STOP_REQUESTED = Uw;
    var Ww = 'IX2_CLEAR_REQUESTED';
    ae.IX2_CLEAR_REQUESTED = Ww;
    var Bw = 'IX2_EVENT_LISTENER_ADDED';
    ae.IX2_EVENT_LISTENER_ADDED = Bw;
    var kw = 'IX2_EVENT_STATE_CHANGED';
    ae.IX2_EVENT_STATE_CHANGED = kw;
    var Hw = 'IX2_ANIMATION_FRAME_CHANGED';
    ae.IX2_ANIMATION_FRAME_CHANGED = Hw;
    var jw = 'IX2_PARAMETER_CHANGED';
    ae.IX2_PARAMETER_CHANGED = jw;
    var Kw = 'IX2_INSTANCE_ADDED';
    ae.IX2_INSTANCE_ADDED = Kw;
    var zw = 'IX2_INSTANCE_STARTED';
    ae.IX2_INSTANCE_STARTED = zw;
    var Yw = 'IX2_INSTANCE_REMOVED';
    ae.IX2_INSTANCE_REMOVED = Yw;
    var Qw = 'IX2_ELEMENT_STATE_CHANGED';
    ae.IX2_ELEMENT_STATE_CHANGED = Qw;
    var $w = 'IX2_ACTION_LIST_PLAYBACK_CHANGED';
    ae.IX2_ACTION_LIST_PLAYBACK_CHANGED = $w;
    var Zw = 'IX2_VIEWPORT_WIDTH_CHANGED';
    ae.IX2_VIEWPORT_WIDTH_CHANGED = Zw;
    var Jw = 'IX2_MEDIA_QUERIES_DEFINED';
    ae.IX2_MEDIA_QUERIES_DEFINED = Jw;
    var e0 = 'IX2_TEST_FRAME_RENDERED';
    ae.IX2_TEST_FRAME_RENDERED = e0;
  });
  var mf = u((L) => {
    'use strict';
    ...
    var C0 = 'filter';
    L.FILTER = C0;
    var N0 = 'font-variation-settings';
    L.FONT_VARIATION_SETTINGS = N0;
    var q0 = 'width';
    L.WIDTH = q0;
    var L0 = 'height';
    L.HEIGHT = L0;
    var P0 = 'backgroundColor';
    L.BACKGROUND_COLOR = P0;
    var D0 = 'background';
    L.BACKGROUND = D0;
    var M0 = 'borderColor';
    L.BORDER_COLOR = M0;
    ...
    L.AUTO = U0;
    var W0 = ',';
    L.COMMA_DELIMITER = W0;
    var B0 = ':';
    L.COLON_DELIMITER = B0;
    var k0 = '|';
    L.BAR_DELIMITER = k0;
    var H0 = 'CHILDREN';
    L.CHILDREN = H0;
    var j0 = 'IMMEDIATE_CHILDREN';
    L.IMMEDIATE_CHILDREN = j0;
    var K0 = 'SIBLINGS';
    L.SIBLINGS = K0;
    var z0 = 'PARENT';
    L.PARENT = z0;
    ...
    var $0 = 'PLAIN_OBJECT';
    L.PLAIN_OBJECT = $0;
    var Z0 = 'ABSTRACT_NODE';
    L.ABSTRACT_NODE = Z0;
    var J0 = 'RENDER_TRANSFORM';
    L.RENDER_TRANSFORM = J0;
    var eA = 'RENDER_GENERAL';
    L.RENDER_GENERAL = eA;
    var tA = 'RENDER_STYLE';
    L.RENDER_STYLE = tA;
  ...
  var Tf = u((Pn) => {
    ...
    Pn.ixData = void 0;
    var oA = He(),
      { IX2_RAW_DATA_IMPORTED: aA } = oA.IX2EngineActionTypes,
      sA = (e = Object.freeze({}), t) => {
        switch (t.type) {
          case aA:
  ...
  var ar = u((Oe) => {
    ...
    function Ff(e, t, r, n, o, i, a) {
      ...
      return (
        m.length
          ? (c = je.call.apply(je, [null, !1, !1, s, r, n, o, i, a].concat(m)))
  ...
  var Uf = u((Vn) => {
    ...
    var dA = fA(or()),
      ...
      mA = (e = yA, t) => {
        if (t.type in Vf) {
          let r = [Vf[t.type]];
          return (0, vA.setIn)(e, [r], (0, dA.default)({}, t.payload));
        }
        return e;
      };
    Vn.ixRequest = mA;
  ...
  var Ur = u((nH, rd) => {
    ...
    sr.prototype.clear = zA;
    sr.prototype.delete = YA;
    sr.prototype.get = QA;
    sr.prototype.has = $A;
    sr.prototype.set = ZA;
    rd.exports = sr;
  ...
  var Pd = u((IH, Ld) => {
    var jS = Wr(),
      KS = Object.prototype,
      zS = KS.hasOwnProperty;
    function YS(e) {
      var t = this.__data__;
      return jS ? t[e] !== void 0 : zS.call(t, e);
    }
    Ld.exports = YS;
  });
  var Md = u((TH, Dd) => {
  ...
  var up = u((MH, sp) => {
    ...
    Hn.prototype.add = Hn.prototype.push = GR;
    Hn.prototype.has = XR;
    sp.exports = Hn;
  });
  var lp = u((FH, cp) => {
  ...
  var da = u((XH, pp) => {
    ...
    function KR(e, t, r, n, o, i) {
      ...
      var f = -1,
        T = !0,
        E = r & jR ? new WR() : void 0;
      for (i.set(e, t), i.set(t, e); ++f < s; ) {
        var I = e[f],
          O = t[f];
        if (n) var C = a ? n(O, I, f, t, e, i) : n(I, O, f, e, t, i);
        if (C !== void 0) {
          if (C) continue;
          T = !1;
          break;
        ...
        if (E) {
          if (
            !BR(t, function (R, q) {
              if (!kR(E, q) && (I === R || o(I, R, r, n, i))) return E.push(q);
            })
          ) {
            T = !1;
            break;
          }
        } else if (!(I === O || o(I, O, r, n, i))) {
          T = !1;
          break;
        }
      }
  ...
  var Op = u((BH, bp) => {
    var mp = tr(),
      ...
      pa = Tp ? Tp.valueOf : void 0;
    function hx(e, t, r, n, o, i, a) {
      switch (r) {
        case vx:
        ...
        case lx:
          var c = n & rx;
          if ((s || (s = tx), e.size != t.size && !c)) return !1;
          var d = a.get(e);
          if (d) return d == t;
          ((n |= nx), a.set(e, t));
          var m = JR(s(e), s(t), n, o, i, a);
          return (a.delete(e), m);
        case dx:
  ...
  var kr = u((ZH, Xp) => {
    var Fp = Mp(),
      Lx = mt(),
      Gp = Object.prototype,
      Px = Gp.hasOwnProperty,
      Dx = Gp.propertyIsEnumerable,
      Mx = Fp(
        (function () {
          return arguments;
        })()
        ...
        ? Fp
        : function (e) {
            return Lx(e) && Px.call(e, 'callee') && !Dx.call(e, 'callee');
          };
    Xp.exports = Mx;
  });
  var Up = u((JH, Vp) => {
  ...
  var Kn = u((Hr, fr) => {
    var Gx = it(),
      Xx = Up(),
      kp = typeof Hr == 'object' && Hr && !Hr.nodeType && Hr,
      Wp = kp && typeof fr == 'object' && fr && !fr.nodeType && fr,
      Vx = Wp && Wp.exports === kp,
      Bp = Vx ? Gx.Buffer : void 0,
      Ux = Bp ? Bp.isBuffer : void 0,
      Wx = Ux || Xx;
    fr.exports = Wx;
  });
  var zn = u((e5, Hp) => {
  ...
  var zp = u((r5, Kp) => {
    ...
    me[$x] =
      ...
      me[cC] =
        !1;
    function IC(e) {
      return Qx(e) && Yx(e.length) && !!me[zx(e)];
    }
    Kp.exports = IC;
  });
  var Qp = u((n5, Yp) => {
  ...
  var Wt = u((c5, sv) => {
    var KC = ua(),
      zC = Yn();
    function YC(e) {
      return e != null && zC(e.length) && !KC(e);
    }
    sv.exports = YC;
  });
  var zr = u((l5, uv) => {
  ...
  var pv = u((d5, dv) => {
    ...
    function sN(e, t, r, n, o, i) {
      ...
      for (var f = c; f--; ) {
        var T = s[f];
        if (!(a ? T in t : aN.call(t, T))) return !1;
      }
      var E = i.get(e),
        I = i.get(t);
      ...
      for (var C = a; ++f < c; ) {
        ...
        var R = e[T],
          q = t[T];
        if (n) var A = a ? n(q, R, T, t, e, i) : n(R, q, T, e, t, i);
        if (!(A === void 0 ? R === q || o(R, q, r, n, i) : A)) {
          O = !1;
          break;
        }
        C || (C = T == 'constructor');
  ...
  var Jn = u((E5, Sv) => {
    var ma = hv(),
      ...
      wN = pr(Oa),
      Bt = Av;
    ((ma && Bt(new ma(new ArrayBuffer(1))) != wv) ||
      (Ia && Bt(new Ia()) != Iv) ||
      (Ta && Bt(Ta.resolve()) != Tv) ||
      (ba && Bt(new ba()) != bv) ||
      (Oa && Bt(new Oa()) != Ov)) &&
  ...
  var Dv = u((_5, Pv) => {
    ...
    function qN(e, t, r, n, o, i) {
      ...
      if (T && !m)
        return (
          i || (i = new wa()),
          a || xN(e) ? AN(e, t, r, n, o, i) : SN(e, t, c, r, n, o, i)
        );
      if (!(r & CN)) {
        var E = m && Lv.call(e, '__wrapped__'),
          I = f && Lv.call(t, '__wrapped__');
        if (E || I) {
          var O = E ? e.value() : e,
            C = I ? t.value() : t;
          return (i || (i = new wa()), o(O, C, r, n, i));
        }
      }
      return T ? (i || (i = new wa()), RN(e, t, r, n, o, i)) : !1;
    }
    Pv.exports = qN;
  });
  var Aa = u((y5, Gv) => {
    ...
    function GN(e, t, r, n) {
      ...
      for (; ++o < i; ) {
        ...
        if (a && s[2]) {
          ...
          var f = new PN();
          if (n) var T = n(d, m, c, e, t, f);
          if (!(T === void 0 ? DN(m, d, MN | FN, n, f) : T)) return !1;
        }
      }
      return !0;
    }
  ...
  var Yr = u((w5, Kv) => {
    var YN = St(),
      ...
      $N = '[object Symbol]';
    function ZN(e) {
      return typeof e == 'symbol' || (QN(e) && YN(e) == $N);
    }
    Kv.exports = ZN;
  });
  var ti = u((A5, zv) => {
    ...
    function nq(e, t) {
      ...
      return r == 'number' ||
        ...
        eq(e)
        ? !0
        : rq.test(e) || !tq.test(e) || (t != null && e in Object(t));
    }
    zv.exports = nq;
  });
  var $v = u((S5, Qv) => {
    ...
    function xa(e, t) {
      ...
      return ((r.cache = new (xa.Cache || Yv)()), r);
    }
    xa.Cache = Yv;
    Qv.exports = xa;
  });
  ...
  var uh = u((N5, sh) => {
    ...
    function ah(e) {
      ...
      if (vq(e)) return pq(e, ah) + '';
      if (hq(e)) return oh ? oh.call(e) : '';
      var t = e + '';
  ...
  var Th = u((V5, Ih) => {
    ...
    function Zq(e, t) {
      return jq(e) && Kq(t)
        ...
        : function (r) {
            var n = kq(r, e);
            return n === void 0 && n === t ? Hq(r, e) : Bq(t, n, Qq | $q);
          };
    }
    Ih.exports = Zq;
  });
  ...
  var Dh = u((Y5, Ph) => {
    var IL = Lh(),
      TL = /^\s+/;
    function bL(e) {
      return e && e.slice(0, IL(e) + 1).replace(TL, '');
    }
    Ph.exports = bL;
  });
  var oi = u((Q5, Gh) => {
    ...
    function CL(e) {
      ...
      e = OL(e);
      var r = SL.test(e);
      return r || RL.test(e) ? xL(e.slice(2), r ? 2 : 8) : AL.test(e) ? Fh : +e;
    }
    Gh.exports = CL;
  });
  var Uh = u(($5, Vh) => {
  ...
  var kh = u((J5, Bh) => {
    ...
    function VL(e, t, r) {
      ...
      if (!n) return -1;
      var o = r == null ? 0 : GL(r);
      return (o < 0 && (o = XL(n + o, 0)), ML(e, FL(t, 3), o));
    }
    Bh.exports = VL;
  });
  var Da = u((ej, Hh) => {
  ...
  var si = u((Ve) => {
    ...
    Ve.withBrowser =
      Ve.TRANSFORM_STYLE_PREFIXED =
      Ve.TRANSFORM_PREFIXED =
      Ve.IS_BROWSER_ENV =
      Ve.FLEX_PREFIXED =
      Ve.ELEMENT_MATCHES =
        void 0;
    ...
    Ve.TRANSFORM_PREFIXED = zh;
    var jh = zh.split('transform')[0],
      zL = jh ? jh + 'TransformStyle' : 'transformStyle';
    Ve.TRANSFORM_STYLE_PREFIXED = zL;
  });
  var Ma = u((rj, Jh) => {
    var YL = 4,
      QL = 0.001,
    ...
    Jh.exports = function (t, r, n, o) {
      ...
      function s(c) {
        for (var d = 0, m = 1, f = $r - 1; m !== f && i[m] <= c; ++m) d += ui;
        --m;
        var T = (c - i[m]) / (i[m + 1] - i[m]),
          E = d + T * ui,
          I = Zh(E, t, n);
        return I >= QL ? tP(c, E, t, n) : I === 0 ? E : eP(c, d, d + ui, t, n);
      }
      return function (d) {
        return t === r && n === o
          ? d
  ...
  var Fa = u((oe) => {
    ...
    oe.bounce = GP;
    oe.bouncePast = XP;
    oe.easeOut = oe.easeInOut = oe.easeIn = oe.ease = void 0;
    oe.inBack = xP;
    oe.inCirc = wP;
    oe.inCubic = lP;
    oe.inElastic = qP;
    ...
    var li = rP(Ma()),
      Tt = 1.70158,
      nP = (0, li.default)(0.25, 0.1, 0.25, 1);
    oe.ease = nP;
    var iP = (0, li.default)(0.42, 0, 1, 1);
    oe.easeIn = iP;
    var oP = (0, li.default)(0, 0, 0.58, 1);
    oe.easeOut = oP;
    var aP = (0, li.default)(0.42, 0, 0.58, 1);
    oe.easeInOut = aP;
    function sP(e) {
      return Math.pow(e, 2);
    }
  ...
  var Xa = u((Zr) => {
    ...
    function kP(e, t, r) {
      return t === 0
        ...
        : t === 1
          ? 1
          : Ga(r ? (t > 0 ? r(t) : t) : t > 0 && e && eg[e] ? eg[e](t) : t);
    }
  });
  var ig = u((hr) => {
    'use strict';
    Object.defineProperty(hr, '__esModule', { value: !0 });
    hr.createElementState = ng;
        ...
        switch (t.type) {
          ...
          case tD: {
            let {
              ...
              c = e;
            return (
              (0, fi.getIn)(c, [r, n]) !== n && (c = ng(c, n, a, r, i)),
              Va(c, r, s, o, i)
            );
          }
          case rD: {
    ...
    function ng(e, t, r, n, o) {
      let i =
        r === HP ? (0, fi.getIn)(o, ['config', 'target', 'objectId']) : null;
  ...
  var og = u((Le) => {
    ...
    Le.getPluginDuration = uD;
    var cD = (e) => e || { value: 0 };
    Le.getPluginOrigin = cD;
    var lD = (e) => ({ value: e.value });
    Le.getPluginDestination = lD;
    var fD = (e) => {
      let t = window.Webflow.require('lottie').createInstance(e);
      return (t.stop(), t.setSubframe(!0), t);
    };
    Le.createPluginInstance = fD;
    var dD = (e, t, r) => {
      if (!e) return;
  ...
  var fg = u((di) => {
    ...
    var ug = OD(or()),
      ...
      AD = lg(sg()),
      SD = new Map([
        [cg.ActionTypeConsts.PLUGIN_LOTTIE, (0, ug.default)({}, wD)],
        [cg.ActionTypeConsts.PLUGIN_SPLINE, (0, ug.default)({}, AD)],
      ]);
    di.pluginMethodMap = SD;
  });
  var Ua = u((Ce) => {
    'use strict';
    ...
    var kt = (e) => (t) => {
      ...
      CD = kt('getPluginConfig');
    Ce.getPluginConfig = CD;
    var ND = kt('getPluginOrigin');
    Ce.getPluginOrigin = ND;
    var qD = kt('getPluginDuration');
    Ce.getPluginDuration = qD;
    var LD = kt('getPluginDestination');
    Ce.getPluginDestination = LD;
    var PD = kt('createPluginInstance');
    Ce.createPluginInstance = PD;
  ...
  var Cg = u((Ij, xg) => {
    ...
    function uM(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((o = oM(r)), (o = r < 0 ? aM(n + o, 0) : sM(o, n - 1))),
        nM(e, iM(t, 3), o, !0)
      );
    }
    xg.exports = uM;
  ...
  var Pg = u((pi) => {
    ...
    function pM(e, t) {
      ...
      for (let o = 0; o < r.length; o++)
        if (!dM.call(t, r[o]) || !Lg(e[r[o]], t[r[o]])) return !1;
      return !0;
    }
    var vM = pM;
    pi.default = vM;
  ...
  var Jg = u((_e) => {
    ...
    _e.getElementId = MM;
    _e.getInstanceId = PM;
    _e.getInstanceOrigin = BM;
    _e.getItemConfigByKey = void 0;
    _e.getMaxDurationItemIndex = Zg;
    ...
    var Ct = Ei(vg()),
      ...
      Kg = (e) => e.trim(),
      Ya = Object.freeze({ [Ir]: Bg, [Tr]: AM, [br]: SM }),
      zg = Object.freeze({
    ...
    var GM = (e, t) => e === t;
    function XM({ store: e, select: t, onChange: r, comparator: n = GM }) {
    ...
    function Qa({
      ...
      if (
        (te
          ? ((U = z.limitAffectedElements), (N = P), (h = m(z)))
          : (N = h = m({ id: q, selector: X, selectorGuids: V })),
        t && B)
      ) {
        let S = r && (h || B === !0) ? [r] : f(P);
        if (h) {
          if (B === xM) return f(h).filter((F) => S.some((j) => O(F, j)));
          if (B === Mg) return f(h).filter((F) => S.some((j) => O(j, F)));
          if (B === Fg) return f(h).filter((F) => S.some((j) => C(j, F)));
        }
        return S;
      }
    ...
    function BM(e, t = {}, r = {}, n, o) {
      ...
      switch (n.actionTypeId) {
        ...
        case jg:
          return { value: (0, Ct.default)(parseFloat(i(e, hi)), 1) };
        case mr: {
          let s = i(e, vt),
            c = i(e, ht),
            d,
          ...
          return (
            ...
            n.config.heightUnit === Nt
              ? (m = Xg.test(c) ? parseFloat(c) : parseFloat(r.height))
        ...
        case _i:
          return { value: (0, Ct.default)(i(e, gi), r.display) };
        case NM:
    ...
    function KM({ element: e, actionItem: t, elementApi: r }) {
      ...
      switch (t.actionTypeId) {
        ...
        case mr: {
          ...
          if (a === Nt) {
            let m = n(e, vt);
            (o(e, vt, ''), (c = i(e, 'offsetWidth')), o(e, vt, m));
          }
          if (s === Nt) {
            let m = n(e, ht);
            (o(e, ht, ''), (d = i(e, 'offsetHeight')), o(e, ht, m));
          }
    ...
    function e1(e, t, r, n, o) {
      let i = JM.map((s) => {
          ...
          switch (s) {
            case Er:
              return `${_M}(${d}${T}, ${m}${E}, ${f}${I})`;
            case _r:
              return `${yM}(${d}${T}, ${m}${E}, ${f}${I})`;
            case yr:
              return `${mM}(${d}${T}) ${IM}(${m}${E}) ${TM}(${f}${I})`;
            case rn:
              return `${bM}(${d}${T}, ${m}${E})`;
            default:
              return '';
      ...
      (jt(e, Ue.TRANSFORM_PREFIXED, o),
        ...
        n1(n, r) && a(e, Ue.TRANSFORM_STYLE_PREFIXED, OM));
    }
    function t1(e, t, r, n) {
    ...
    function c1(e, t, r, n, o, i) {
      ...
      switch (n.actionTypeId) {
        case mr: {
          ...
          (d !== void 0 &&
            (s === Nt && (s = 'px'), jt(e, vt, i), a(e, vt, d + s)),
            m !== void 0 &&
              (c === Nt && (c = 'px'), jt(e, ht, i), a(e, ht, m + c)));
          break;
        }
        case nn: {
          t1(e, r, n.config, i);
    ...
    function l1(e, t, r) {
      ...
      switch (t.actionTypeId) {
        case _i: {
          ...
          o === wM && Ue.IS_BROWSER_ENV
            ? n(e, gi, Ue.FLEX_PREFIXED)
            : n(e, gi, o);
          return;
        }
      }
    ...
    function f1({ store: e, elementApi: t }) {
      ...
      (Object.keys(n).forEach((i) => {
        let a = n[i],
          ...
          { actionListId: c } = s,
          d = o[c];
        d && Vg({ actionList: d, event: a, elementApi: t });
      }),
        Object.keys(o).forEach((i) => {
          Vg({ actionList: o[i], elementApi: t });
        }));
    }
    ...
    function Ug({ actionGroup: e, event: t, elementApi: r }) {
      ...
      n.forEach(({ actionTypeId: o, config: i }) => {
        ...
        ((0, gt.isPluginType)(o)
          ...
          : (a = $g({ effect: p1, actionTypeId: o, elementApi: r })),
          Qa({ config: i, event: t, elementApi: r }).forEach(a));
      });
    }
    function d1(e, t, r) {
      ...
      o(e, gr) && $g({ effect: Qg, actionTypeId: i, elementApi: r })(e);
    }
    var $g =
    ...
    function v1(e, t) {
      ...
      return (
        r.forEach((c, d) => {
          ...
          let { actionItems: m } = c,
            f = m[Zg(m)],
            { config: T, actionTypeId: E } = f;
          o.id === f.id && (s = a + i);
          let I = Yg(E) === Ka ? 0 : T.duration;
          a += T.delay + I;
        }),
        a > 0 ? (0, hM.optimizeFloat)(s / a) : 0
      );
    }
    function h1({ actionList: e, actionItemId: t, rawData: r }) {
      let { actionItemGroups: n, continuousParameterGroups: o } = e,
        i = [],
        a = (s) => (
          i.push((0, Dg.mergeIn)(s, ['config'], { delay: 0, duration: 0 })),
          s.id === t
        );
      return (
  ...
  var Kt = u((We) => {
    ...
    We.IX2VanillaUtils =
      ...
      We.IX2BrowserSupport =
        void 0;
    var I1 = Or(si());
    We.IX2BrowserSupport = I1;
    var T1 = Or(Fa());
    We.IX2Easings = T1;
    var b1 = Or(Xa());
    We.IX2EasingUtils = b1;
    var O1 = Or(ig());
    We.IX2ElementsReducer = O1;
    var w1 = Or(Ua());
    We.IX2VanillaPlugins = w1;
    var A1 = Or(Jg());
    We.IX2VanillaUtils = A1;
  });
  var nE = u((mi) => {
    'use strict';
    ...
    var eE = He(),
      ...
      { RENDER_GENERAL: P1 } = eE.IX2EngineConstants,
      {
      ...
      F1 = (e, t) => {
        ...
        for (let K = 0, { length: z } = o; K < z; K++) {
          let { keyframe: te, actionItems: U } = o[K];
          if ((K === 0 && (A = U[0]), q >= te)) {
            A = U[0];
            let N = o[K + 1],
              h = N && q !== te;
            ((X = h ? N.actionItems[0] : null),
              h && ((V = te / 100), (G = (N.keyframe - te) / 100)));
          }
        }
        let B = {};
        if (A && !X)
          for (let K = 0, { length: z } = i; K < z; K++) {
            let te = i[K];
            B[te] = Za(c, te, A.config);
          }
        else if (A && X && V !== void 0 && G !== void 0) {
          let K = (R - V) / G,
            z = A.config.easing,
            te = rE(z, K, d);
          for (let U = 0, { length: N } = i; U < N; U++) {
            let h = i[U],
              P = Za(c, h, A.config),
              j = (Za(c, h, X.config) - P) * te + P;
            B[h] = j;
          }
        }
        return (0, wr.merge)(e, { position: R, current: B });
      },
      G1 = (e, t) => {
        let {
            active: r,
        ...
        if (r && n) {
          ...
          if (s) {
            let K = q - o,
              z = C + R,
              te = yi(Math.min(Math.max(0, K / z), 1));
            e = (0, wr.set)(e, 'verboseTimeElapsed', z * te);
          }
          if (A < 0) return e;
          let X = yi(Math.min(Math.max(0, A / C), 1)),
            V = rE(O, X, E),
            G = {},
            B = null;
          return (
        ...
        switch (t.type) {
          ...
          case x1: {
            let {
              ...
              te = D1(z),
              U = M1(te, z),
              N = Object.keys(T).filter((P) => T[P] != null),
              { easing: h } = o.config;
            return (0, wr.set)(e, r, {
              id: r,
              elementId: n,
              ...
              skipToValue: K,
              customEasingFn:
                Array.isArray(h) && h.length === 4 ? L1(h) : void 0,
            });
          }
          case C1: {
  ...
  var oE = u((Ti) => {
    ...
    var H1 = ea(),
      ...
      Q1 = nE(),
      $1 = iE(),
      { ixElements: Z1 } = Y1.IX2ElementsReducer,
  ...
  var uE = u((Cj, sE) => {
    var t2 = St(),
      ...
      i2 = '[object String]';
    function o2(e) {
      return typeof e == 'string' || (!r2(e) && n2(e) && t2(e) == i2);
    }
    sE.exports = o2;
  });
  var lE = u((Nj, cE) => {
  ...
  var IE = u((Lj, mE) => {
    var vE = '\\ud800-\\udfff',
      ...
      _E = b2 + '?',
      yE = '[' + I2 + ']?',
      w2 = '(?:' + O2 + '(?:' + [hE, gE, EE].join('|') + ')' + yE + _E + ')*',
      A2 = yE + _E + w2,
      S2 = '(?:' + [hE + Ja + '?', Ja, gE, EE, T2].join('|') + ')',
      pE = RegExp(es + '(?=' + es + ')|' + S2 + A2, 'g');
    function R2(e) {
  ...
  var wE = u((Dj, OE) => {
    ...
    function V2(e) {
      if (e == null) return 0;
      if (D2(e)) return M2(e) ? F2(e) : e.length;
      var t = P2(e);
      return t == G2 || t == X2 ? e.size : L2(e).length;
    }
    OE.exports = V2;
  });
  var SE = u((Mj, AE) => {
  ...
  var rs = u((Gj, CE) => {
    ...
    function H2(e, t, r) {
      t == '__proto__' && xE
        ? xE(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 })
        : (e[t] = r);
    }
    CE.exports = H2;
  });
  var qE = u((Xj, NE) => {
    ...
    function Q2(e, t, r) {
      var n = e[t];
      (!(Y2.call(e, t) && K2(n, r)) || (r === void 0 && !(t in e))) &&
        j2(e, t, r);
    }
    NE.exports = Q2;
  });
  ...
  var BE = u((kj, WE) => {
    var pF = pt(),
      ...
      hF = UE(),
      gF = Object.prototype,
      EF = gF.hasOwnProperty;
    function _F(e) {
      if (!pF(e)) return hF(e);
      var t = vF(e),
        r = [];
      for (var n in e)
        (n == 'constructor' && (t || !EF.call(e, n))) || r.push(n);
      return r;
    }
    WE.exports = _F;
  });
  ...
  var JE = u((Yj, ZE) => {
    ...
    function zF(e) {
      ...
      if (
        ...
        return !e.length;
      var t = FF(e);
      if (t == kF || t == HF) return !e.size;
      if (WF(e)) return !MF(e).length;
      for (var r in e) if (KF.call(e, r)) return !1;
      return !0;
    }
    ZE.exports = zF;
  });
    ...
    function pG(e, t, r) {
      ...
      ((t = l_(t) || 0),
        cG(r) &&
          ((m = !!r.leading),
          (f = 'maxWait' in r),
          (i = f ? fG(l_(r.maxWait) || 0, t) : i),
          (T = 'trailing' in r ? !!r.trailing : T)));
      function E(G) {
        var B = n,
          K = o;
        return ((n = o = void 0), (d = G), (a = e.apply(K, B)), a);
      }
      function I(G) {
        return ((d = G), (s = setTimeout(R, t)), m ? E(G) : a);
      }
      function O(G) {
        var B = G - c,
          K = G - d,
      ...
      function q(G) {
        return ((s = void 0), T && n ? E(G) : ((n = o = void 0), a));
      }
      function A() {
        (s !== void 0 && clearTimeout(s), (d = 0), (n = c = o = s = void 0));
      }
      function X() {
        return s === void 0 ? a : q(ns());
      }
      function V() {
        var G = ns(),
          B = C(G);
        if (((n = arguments), (o = this), (c = G), B)) {
          ...
          if (f) return (clearTimeout(s), (s = setTimeout(R, t)), E(c));
        }
        return (s === void 0 && (s = setTimeout(R, t)), a);
      }
      return ((V.cancel = A), (V.flush = X), V);
    }
    f_.exports = pG;
  });
  var v_ = u((rK, p_) => {
    ...
    function EG(e, t, r) {
      ...
      return (
        ...
        vG(e, t, { leading: n, maxWait: t, trailing: o })
      );
    }
    p_.exports = EG;
  });
  var bi = u((se) => {
    ...
    se.viewportWidthChanged =
      se.testFrameRendered =
      se.stopRequested =
      se.sessionStopped =
      se.sessionStarted =
      se.sessionInitialized =
      se.rawDataImported =
      se.previewRequested =
      se.playbackRequested =
      se.parameterChanged =
      se.mediaQueriesDefined =
      se.instanceStarted =
      se.instanceRemoved =
      se.instanceAdded =
      se.eventStateChanged =
      se.eventListenerAdded =
      se.elementStateChanged =
      se.clearRequested =
      se.animationFrameChanged =
      se.actionListPlaybackChanged =
        void 0;
    var h_ = _G(or()),
      g_ = He(),
      yG = Kt(),
      ...
      UG = (e) => ({ type: mG, payload: (0, h_.default)({}, VG(e)) });
    se.rawDataImported = UG;
    var WG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
      type: IG,
      payload: { hasBoundaryNodes: e, reducedMotion: t },
    });
    se.sessionInitialized = WG;
    var BG = () => ({ type: TG });
    se.sessionStarted = BG;
    var kG = () => ({ type: bG });
    se.sessionStopped = kG;
    var HG = ({ rawData: e, defer: t }) => ({
      type: OG,
      payload: { defer: t, rawData: e },
    });
    se.previewRequested = HG;
    var jG = ({
    ...
    se.playbackRequested = jG;
    var KG = (e) => ({ type: AG, payload: { actionListId: e } });
    se.stopRequested = KG;
    var zG = () => ({ type: SG });
    se.clearRequested = zG;
    var YG = (e, t) => ({
      type: RG,
      payload: { target: e, listenerParams: t },
    });
    se.eventListenerAdded = YG;
    var QG = (e = 1) => ({ type: xG, payload: { step: e } });
    se.testFrameRendered = QG;
    var $G = (e, t) => ({ type: CG, payload: { stateKey: e, newState: t } });
    se.eventStateChanged = $G;
    var ZG = (e, t) => ({ type: NG, payload: { now: e, parameters: t } });
    se.animationFrameChanged = ZG;
    var JG = (e, t) => ({ type: qG, payload: { key: e, value: t } });
    se.parameterChanged = JG;
    var eX = (e) => ({ type: LG, payload: (0, h_.default)({}, e) });
    se.instanceAdded = eX;
    var tX = (e, t) => ({ type: PG, payload: { instanceId: e, time: t } });
    se.instanceStarted = tX;
    var rX = (e) => ({ type: DG, payload: { instanceId: e } });
    se.instanceRemoved = rX;
    var nX = (e, t, r, n) => ({
      type: MG,
      payload: { elementId: e, actionTypeId: t, current: r, actionItem: n },
    });
    se.elementStateChanged = nX;
    var iX = ({ actionListId: e, isPlaying: t }) => ({
      type: FG,
      payload: { actionListId: e, isPlaying: t },
    });
    se.actionListPlaybackChanged = iX;
    var oX = ({ width: e, mediaQueries: t }) => ({
      type: GG,
      payload: { width: e, mediaQueries: t },
    });
    se.viewportWidthChanged = oX;
    var aX = () => ({ type: XG });
    se.mediaQueriesDefined = aX;
  });
  var y_ = u((De) => {
    'use strict';
    Object.defineProperty(De, '__esModule', { value: !0 });
    De.elementContains = _X;
    De.getChildElements = mX;
    De.getClosestElement = void 0;
    De.getProperty = pX;
    De.getQuerySelector = hX;
    De.getRefType = bX;
    De.getSiblingElements = IX;
    De.getStyle = dX;
    De.getValidDocument = gX;
    De.isSiblingNode = yX;
    De.matchSelector = vX;
    De.queryDocument = EX;
    De.setStyle = fX;
    var sX = Kt(),
      uX = He(),
      { ELEMENT_MATCHES: is } = sX.IX2BrowserSupport,
      {
        IX2_ID_DELIMITER: E_,
        HTML_ELEMENT: cX,
        PLAIN_OBJECT: lX,
    ...
    function hX({ id: e, selector: t }) {
      if (e) {
        let r = e;
        if (e.indexOf(E_) !== -1) {
          let n = e.split(E_),
            o = n[0];
          if (((r = n[1]), o !== document.documentElement.getAttribute(__)))
            return null;
        }
  ...
  var F_ = u((dK, M_) => {
    ...
    function GX(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, o = -1, i = D_(n.length - t, 0), a = Array(i);
            ++o < i;
          )
            a[o] = n[t + o];
          o = -1;
  ...
  var ss = u((TK, oy) => {
    ...
    function sV(e) {
      for (
        var t = e.name + '', r = iy[t], n = aV.call(iy, t) ? r.length : 0;
        n--;
      ) {
        var o = r[n],
          i = o.func;
  ...
  var py = u((AK, dy) => {
    ...
    function xi(e) {
      if (yV(e) && !_V(e) && !(e instanceof gV)) {
        if (e instanceof fy) return e;
        if (TV.call(e, '__wrapped__')) return mV(e);
      }
      return new fy(e);
    }
  ...
  var yy = u((RK, _y) => {
    ...
    function MV(e) {
      return RV(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          var i = t[n];
          if (typeof i != 'function') throw new TypeError(NV);
          if (o && !a && us(i) == 'wrapper') var a = new gy([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          i = t[n];
          var s = us(i),
            c = s == 'wrapper' ? xV(i) : void 0;
          c &&
          Ey(c[0]) &&
          c[1] == (PV | qV | LV | DV) &&
          !c[4].length &&
          c[9] == 1
            ...
            : (a = i.length == 1 && Ey(i) ? a[s]() : a.thru(i));
        }
        return function () {
          var d = arguments,
            m = d[0];
          if (a && d.length == 1 && CV(m)) return a.plant(m).value();
          for (var f = 0, T = r ? t[f].apply(this, d) : m; ++f < r; )
            T = t[f].call(this, T);
          return T;
        };
      });
  ...
  var By = u((Pi) => {
    ...
    var Qe = Li(or()),
      ...
      fs = 'COMPONENT_ACTIVE',
      Gy = 'COMPONENT_INACTIVE',
      { COLON_DELIMITER: Ay } = zt.IX2EngineConstants,
      { getNamespacedParameterId: Sy } = HV.IX2VanillaUtils,
      Xy = (e) => (t) => (typeof t == 'object' && e(t) ? !0 : t),
      un = Xy(({ element: e, nativeEvent: t }) => e === t.target),
      pU = Xy(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      Et = (0, WV.default)([un, pU]),
      Vy = (e, t) => {
        if (t) {
          let { ixData: r } = e.getState(),
            { events: n } = r,
        ...
        return (
          d &&
            (0, ls.stopActionGroup)({
              ...
              eventId: c,
              eventTarget: r,
              eventStateKey: c + Ay + n.split(Ay)[1],
              actionListId: (0, BV.default)(d, 'action.config.actionListId'),
            }),
          (0, ls.stopActionGroup)({
            store: e,
            eventId: a,
      ...
      cn = { handler: ot(Et, Ke) },
      Uy = (0, Qe.default)({}, cn, { types: [fs, Gy].join(' ') }),
      ds = [
      ...
      Ry = 'mouseover mouseout',
      ps = { types: ds },
      hU = { PAGE_START: Fy, PAGE_FINISH: My },
      sn = (() => {
      ...
      Wy = (e) => (t, r) => {
        let { type: n } = t.nativeEvent,
          o = [fs, Gy].indexOf(n) !== -1 ? n === fs : r.isActive,
          i = (0, Qe.default)({}, r, { isActive: o });
      ...
      yU = (e) => (t, r) => {
        let n = (0, Qe.default)({}, r, { elementVisible: _U(t) });
        return (
      ...
      Cy =
        ...
        (t, r = {}) => {
          let { stiffScrollTop: n, scrollHeight: o, innerHeight: i } = sn(),
            ...
            m = d === 'PX',
            f = o - i,
            T = Number((n / f).toFixed(2));
          if (r && r.percentTop === T) return r;
          let E = (m ? c : (i * (c || 0)) / 100) / f,
            I,
            O,
            C = 0;
          r &&
      ...
      Ni = (e = !0) =>
        (0, Qe.default)({}, Uy, {
          handler: ot(
            e ? Et : un,
            Wy((t, r) => (r.isActive ? cn.handler(t, r) : r))
          ),
        }),
      qi = (e = !0) =>
        (0, Qe.default)({}, Uy, {
          handler: ot(
            e ? Et : un,
            Wy((t, r) => (r.isActive ? r : cn.handler(t, r)))
          ),
        }),
      qy = (0, Qe.default)({}, ps, {
        handler: yU((e, t) => {
          ...
          return !a[n.action.config.autoStopEventId] && t.triggered
            ? t
            : (n.eventTypeId === Dy) === r
              ? (Ke(e), (0, Qe.default)({}, t, { triggered: !0 }))
              : t;
        }),
      }),
      Ly = 0.05,
      bU = {
        ...
        [rU]: Ni(),
        [nU]: qi(),
        [fU]: { types: 'ecommerce-cart-open', handler: ot(Et, Ke) },
        [lU]: { types: 'ecommerce-cart-close', handler: ot(Et, Ke) },
        [jV]: {
          types: 'click',
          handler: ot(
            Et,
        ...
        [zV]: (0, Qe.default)({}, cn, { types: 'mousedown' }),
        [YV]: (0, Qe.default)({}, cn, { types: 'mouseup' }),
        [QV]: {
          types: Ry,
          handler: ot(
            Et,
          ...
          handler: (
            ...
            switch (a) {
              ...
              case zt.EventBasedOn.PAGE: {
                ...
                R = O ? Math.min(X + E, G) / G : Math.min(V + I, B) / B;
                break;
              }
              ...
              default: {
                ...
                if (X && Et({ element: t, nativeEvent: n }) !== !0) break;
                let V = t.getBoundingClientRect(),
                  { left: G, top: B, width: K, height: z } = V;
                if (!X && !mU({ left: f, top: T }, V)) break;
                ((A = !0), (R = O ? (f - G) / K : (T - B) / z));
                break;
              }
            }
            return (
              C && (R > 1 - Ly || R < Ly) && (R = Math.round(R)),
              (a !== zt.EventBasedOn.ELEMENT || A || A !== i.elementHovered) &&
                ((R = d ? 1 - R : R),
                e.dispatch((0, Ci.parameterChanged)(q, R))),
              { elementHovered: A, clientX: f, clientY: T, pageX: E, pageY: I }
            );
          },
        },
        [dU]: {
        ...
        [cU]: {
          ...
          handler: (
            ...
            let {
              ...
              A = f === 'X_AXIS';
            if (m === zt.EventBasedOn.VIEWPORT) {
              let X = A ? i / s : a / c;
              return (
                X !== o.scrollPercent &&
                  t.dispatch((0, Ci.parameterChanged)(T, X)),
                { scrollPercent: X }
              );
            } else {
              let X = Sy(n, T),
                ...
                B = (O ? q : 0) / 100;
              ((G = E ? G : 1 - G), (B = I ? B : 1 - B));
              let K = V.top + Math.min(V.height * G, d),
                te = V.top + V.height * B - K,
                U = Math.min(d + te, c),
                h = Math.min(Math.max(0, d - K), U) / U;
              return (
                h !== o.scrollPercent &&
                  t.dispatch((0, Ci.parameterChanged)(X, h)),
                { scrollPercent: h }
              );
            }
          },
  ...
  var vs = u((Lt) => {
    ...
    var wU = st(or()),
      ...
      xe = OU(y_()),
      LU = st(By()),
      PU = ['store', 'computedStyle'],
      DU = Object.keys(at.QuickEffectIds),
      hs = (e) => DU.includes(e),
      {
        COLON_DELIMITER: gs,
      ...
      ZU = Hy.match(/iPad/i) || Hy.match(/iPhone/),
      JU = 12;
    function eW(e) {
      (Yt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: nW }),
        Yt({
          store: e,
          select: ({ ixRequest: t }) => t.playback,
          onChange: iW,
        }),
        Yt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: oW }),
        Yt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: aW }));
    }
    function tW(e) {
      Yt({
        store: e,
    ...
    function nW({ rawData: e, defer: t }, r) {
      let n = () => {
        (Xi({ store: r, rawData: e, allowEvents: !0 }), Yy());
      };
      t ? setTimeout(n, 0) : n();
    }
    function Yy() {
    ...
    function iW(e, t) {
      ...
      if (n && o && m && s) {
        ...
        f && (m = BU({ actionList: f, actionItemId: o, rawData: m }));
      }
      if (
        (Xi({ store: t, rawData: m, allowEvents: a, testManual: c }),
        (n && r === at.ActionTypeConsts.GENERAL_START_ACTION) || hs(r))
      ) {
    ...
    function oW({ actionListId: e }, t) {
      (e ? ys({ store: t, actionListId: e }) : Zy({ store: t }), Vi(t));
    }
    function aW(e, t) {
      (Vi(t), zy({ store: t, elementApi: xe }));
    }
      ...
      (t && e.dispatch((0, we.rawDataImported)(t)),
        o.active ||
          ...
          r &&
            (dW(e),
            sW(),
            e.getState().ixSession.hasDefinedMediaQueries && tW(e)),
    ...
    function uW(e, t) {
      let r = (n) => {
        ...
        o.active &&
          ...
          t ? rW(e, r) : requestAnimationFrame(r));
      };
    ...
    function Vi(e) {
      ...
      if (t.active) {
        ...
        (r.forEach(cW), KU(), e.dispatch((0, we.sessionStopped)()));
      }
    }
    function cW({ target: e, listenerParams: t }) {
    ...
    function lW({
      ...
      let { ixData: d, ixSession: m } = e.getState(),
        ...
        { id: q } = a;
      kU(E, o) && (q = HU(t, q));
      let A = m.hasBoundaryNodes && r ? xe.getClosestElement(r, Di) : null;
      (R.forEach((X) => {
        let { keyframe: V, actionItems: G } = X;
        G.forEach((B) => {
          let { actionTypeId: K } = B,
            { target: z } = B.config;
          if (!z) return;
          let te = z.boundaryMode ? A : null,
            U = zU(z) + gs + K;
          if (((O[U] = fW(O[U], V, B)), !I[U])) {
            I[U] = !0;
            let { config: N } = B;
            Mi({
              config: N,
              ...
              C.push({ element: h, key: U });
            });
          }
        });
      }),
        C.forEach(({ element: X, key: V }) => {
          let G = O[V],
            B = (0, qt.default)(G, '[0].actionItems[0]', {}),
            { actionTypeId: K } = B,
            z = Gi(K) ? _s(K)(X, B) : null,
            te = Es({ element: X, actionItem: B, elementApi: xe }, z);
          Is({
            store: e,
            element: X,
            eventId: n,
    ...
    function dW(e) {
      ...
      (Qy(e),
        (0, ln.default)(r, (o, i) => {
          ...
          _W({ logic: a, store: e, events: o });
        }));
      let { ixSession: n } = e.getState();
      n.eventListeners.length && vW(e);
    }
    var pW = ['resize', 'orientationchange'];
    function vW(e) {
      let t = () => {
        Qy(e);
      };
    ...
    var hW = (e, t) => (0, xU.default)((0, NU.default)(e, t), CU.default),
      gW = (e, t) => {
        (0, ln.default)(e, (r, n) => {
          r.forEach((o, i) => {
            let a = n + gs + i;
    ...
    function _W({ logic: e, store: t, events: r }) {
      yW(r);
      let { types: n, handler: o } = e,
        { ixData: i } = t.getState(),
        { actionLists: a } = i,
        s = hW(r, EW);
      if (!(0, RU.default)(s)) return;
      (0, ln.default)(s, (f, T) => {
        let E = r[T],
          { action: I, id: O, mediaQueries: C = i.mediaQueryKeys } = E,
          { actionListId: R } = I.config;
        (YU(C, i.mediaQueryKeys) || t.dispatch((0, we.mediaQueriesDefined)()),
          I.actionTypeId === at.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(E.config) ? E.config : [E.config]).forEach((A) => {
              let { continuousParameterGroupId: X } = A,
                V = (0, qt.default)(a, `${R}.continuousParameterGroups`, []),
                G = (0, SU.default)(V, ({ id: z }) => z === X),
                B = (A.smoothing || 0) / 100,
          ...
          (I.actionTypeId === at.ActionTypeConsts.GENERAL_START_ACTION ||
            hs(I.actionTypeId)) &&
            $y({ store: t, actionListId: R, eventId: O }));
      });
      let c = (f) => {
          ...
          gW(s, (E, I, O) => {
            ...
            if (!Fi(A, T.mediaQueryKey)) return;
            let X = (V = {}) => {
              let G = o(
                {
                  store: t,
              ...
              QU(G, R) || t.dispatch((0, we.eventStateChanged)(O, G));
            };
        ...
        d = (0, qU.default)(c, JU),
        m = ({ target: f = document, types: T, throttle: E }) => {
          T.split(' ')
            .filter(Boolean)
            .forEach((I) => {
              let O = E ? d : c;
              (f.addEventListener(I, O),
                t.dispatch((0, we.eventListenerAdded)(f, [I, O])));
            });
        };
    ...
    function $y({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        let d = (0, qt.default)(c, 'actionItemGroups[0].actionItems', []),
          m = (0, qt.default)(s, 'mediaQueries', n.mediaQueryKeys);
        if (!Fi(m, o.mediaQueryKey)) return;
        d.forEach((f) => {
          var T;
          let { config: E, actionTypeId: I } = f,
            O =
              (E == null || (T = E.target) === null || T === void 0
                ...
                : E,
            C = Mi({ config: O, event: s, elementApi: xe }),
            R = Gi(I);
          C.forEach((q) => {
            let A = R ? _s(I)(q, f) : null;
            Is({
              destination: Es({ element: q, actionItem: f, elementApi: xe }, A),
              immediate: !0,
              store: e,
              element: q,
              eventId: r,
    ...
    function ms({
      ...
      let { ixData: d, ixSession: m } = e.getState(),
        { events: f } = d,
        T = f[t] || {},
        { mediaQueries: E = d.mediaQueryKeys } = T,
        I = (0, qt.default)(d, `actionLists.${o}`, {}),
        { actionItemGroups: O, useFirstGroupAsInitialState: C } = I;
      if (!O || !O.length) return !1;
      (i >= O.length && (0, qt.default)(T, 'config.loop') && (i = 0),
        i === 0 && C && i++);
      let q =
          (i === 0 || (i === 1 && C)) &&
          hs((c = T.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? T.config.delay
            : void 0,
        A = (0, qt.default)(O, [i, 'actionItems'], []);
      if (!A.length || !Fi(E, m.mediaQueryKey)) return !1;
      let X = m.hasBoundaryNodes && r ? xe.getClosestElement(r, Di) : null,
        V = VU(A),
        G = !1;
      return (
        A.forEach((B, K) => {
          let { config: z, actionTypeId: te } = B,
            U = Gi(te),
            { target: N } = z;
          if (!N) return;
          let h = N.boundaryMode ? X : null;
          Mi({
            config: z,
            event: T,
            eventTarget: r,
            ...
            let j = U ? _s(te)(S, B) : null,
              Z = U ? $U(te)(S, B) : null;
            G = !0;
            let fe = V === K && F === 0,
              ce = UU({ element: S, actionItem: B }),
              _ = Es({ element: S, actionItem: B, elementApi: xe }, j);
            Is({
              store: e,
              element: S,
              actionItem: B,
    ...
    function Is(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        T = !d,
        E = GU(),
        { ixElements: I, ixSession: O, ixData: C } = r.getState(),
        R = FU(I, i),
        { refState: q } = I[R] || {},
        A = xe.getRefType(i),
        X = O.reducedMotion && at.ReducedMotionTypes[a.actionTypeId],
        V;
      if (X && d)
        switch (
      ...
      if (
        ...
        Jy(document.body, 'ix2-animation-started', E),
        s)
      ) {
        mW(r, E);
        return;
      }
      (Yt({ store: r, select: ({ ixInstances: B }) => B[E], onChange: em }),
        T && r.dispatch((0, we.instanceStarted)(E, O.tick)));
    }
    function Ts(e, t) {
      ...
      let { elementId: r, actionItem: n } = e,
        ...
        { ref: i, refType: a } = o[r] || {};
      (a === Ky && jU(i, n, xe), t.dispatch((0, we.instanceRemoved)(e.id)));
    }
    function Jy(e, t, r) {
    ...
    function em(e, t) {
      let {
        ...
        { ixData: A, ixSession: X } = t.getState(),
        { events: V } = A,
        G = V[f] || {},
        { mediaQueries: B = A.mediaQueryKeys } = G;
      if (Fi(B, X.mediaQueryKey) && (n || r || o)) {
        if (d || (c === MU && o)) {
          t.dispatch((0, we.elementStateChanged)(i, s, d, a));
          let { ixElements: K } = t.getState(),
            { ref: z, refType: te, refState: U } = K[i] || {},
            N = U && U[s];
          (te === Ky || Gi(s)) && XU(z, U, N, f, a, C, xe, c, q);
        }
        if (o) {
          if (O) {
            let K = ms({
  ...
  var rm = u((bt) => {
    ...
    var bW = ea(),
      ...
      wW = IW(bi());
    bt.actions = wW;
    var Ui = (0, bW.createStore)(OW.default);
    bt.store = Ui;
    function AW(e) {
      e() && (0, bs.observeRequests)(Ui);
    }
    function SW(e) {
      (tm(), (0, bs.startEngine)({ store: Ui, rawData: e, allowEvents: !0 }));
    }
    function tm() {
      (0, bs.stopEngine)(Ui);
    }
  ...
  var um = u((MK, sm) => {
    ...
    Ar.define(
      ...
      (sm.exports = function (e, t) {
        ...
        function E() {
          ((o = i && Ar.env('design')),
            (T = Ar.env('slug') || a.pathname || ''),
            Ar.scroll.off(O),
            (f = []));
          for (var R = document.links, q = 0; q < R.length; ++q) I(R[q]);
          f.length && (Ar.scroll.on(O), O());
        }
        function I(R) {
          var q =
          ...
          if (((s.href = q), !(q.indexOf(':') >= 0))) {
            ...
            if (
              ...
              var X = e(s.hash);
              X.length && f.push({ link: A, sec: X, active: !1 });
              return;
            }
            if (!(q === '#' || q === '')) {
              var V = s.href === a.href || q === T || (d.test(q) && m.test(T));
              C(A, c, V);
            }
          }
        }
        function O() {
          ...
          t.each(f, function (A) {
            var X = A.link,
              ...
              B = V.outerHeight(),
              K = q * 0.5,
              z = V.is(':visible') && G + B - K >= R && G + K <= R + q;
            A.active !== z && ((A.active = z), C(X, c, z));
          });
        }
        function C(R, q, A) {
          var X = R.hasClass(q);
          (A && X) || (!A && !X) || (A ? R.addClass(q) : R.removeClass(q));
        }
        return r;
      })
    );
  ...
  var lm = u((FK, cm) => {
    ...
    Wi.define(
      ...
      (cm.exports = function (e) {
        ...
        var O = /^#[a-zA-Z0-9][\w:.-]*$/;
        function C(N) {
          return O.test(N.hash) && N.host + N.pathname === r.host + r.pathname;
        }
        let R =
        ...
        function G(N, h) {
          ...
          if (P !== S) {
            var F = K(N, P, S),
              ...
              Z = function () {
                var fe = Date.now() - j;
                (window.scroll(0, z(P, S, fe, F)),
                  fe <= F ? s(Z) : typeof h == 'function' && h());
              };
            s(Z);
          }
        }
        ...
        function K(N, h, P) {
          ...
          var S = 1;
          return (
            a.add(N).each(function (F, j) {
              var Z = parseFloat(j.getAttribute('data-scroll-time'));
              !isNaN(Z) && Z >= 0 && (S = Z);
            }),
            (472.143 * Math.log(Math.abs(h - P) + 125) - 2e3) * S
          );
        }
        function z(N, h, P, S) {
          return P > S ? h : N + (h - N) * te(P / S);
        }
        function te(N) {
          return N < 0.5
            ? 4 * N * N * N
      ...
      (fm.exports = function (e) {
        ...
        function n(i) {
          ...
          function f(C) {
            ...
            (R && R.length > 1) ||
              ((a = !0),
              R ? ((s = !0), (d = R[0].clientX)) : (d = C.clientX),
              (m = d));
          }
          function T(C) {
            if (a) {
              ...
              ((m = q),
                Math.abs(A) > c &&
                  r &&
                  String(r()) === '' &&
                  (o('swipe', C, { direction: A > 0 ? 'right' : 'left' }),
                  I()));
            }
          }
          function E(C) {
  ...
  var hm = u((XK, vm) => {
    ...
    function dn(e) {
      return !!(e.$el && e.$el.closest(xW).length);
    }
    function ws(e, t) {
    ...
    function LW(e, t, r, n) {
            ...
            d.forEach(function (y, Q) {
              var re = ce('thumbnail'),
                he = ce('item')
                  ...
                  .attr('role', 'tab')
                  .append(re);
              (fn(he, `show item ${Q + 1} of ${d.length}`),
                dn(y) && he.addClass(pm),
                (f.items = f.items.add(he)),
                te(y.thumbnailUrl || y.url, function (ue) {
                  (ue.prop('width') > ue.prop('height')
                    ? F(ue, 'wide')
                    : F(ue, 'tall'),
                    re.append(F(ue, 'thumbnail-image')));
                }));
            }),
            f.strip.empty().append(f.items),
            F(f.content, 'group')),
          o(j(f.lightbox, 'hide').trigger('focus'))
            .add('opacity .3s')
            .start({ opacity: 1 }),
          F(f.html, 'noscroll'),
          I.show(v || 0)
      ...
      ((I.build = function () {
        return (
          ...
          (f.arrowLeft = ce('control left inactive')
            .attr('role', 'button')
            .attr('aria-hidden', !0)
            .attr('aria-controls', 'w-lightbox-view')),
          (f.arrowRight = ce('control right inactive')
            .attr('role', 'button')
            .attr('aria-hidden', !0)
            .attr('aria-controls', 'w-lightbox-view')),
          ...
          (T = new h(f.spinner, P('hide'))),
          (f.content = ce('content').append(
            f.spinner,
            f.arrowLeft,
            f.arrowRight,
            f.close
          ...
          f.strip.on('click', S('item'), A),
          f.content
            .on('swipe', X)
            .on('click', S('left'), C)
            .on('click', S('right'), R)
            .on('click', S('close'), q)
            .on('click', S('image, caption'), R),
          f.container.on('click', S('view'), q).on('dragstart', S('img'), G),
          f.lightbox.on('keydown', B).on('focusin', V),
          ...
          if (p !== m) {
            ...
            ((m = p),
              f.spinner
                ...
                .attr('aria-valuetext', 'Loading image'),
              T.show());
            var he = (v.html && _(v.width, v.height)) || v.url;
            return (
              te(he, function (ue) {
                if (p !== m) return;
                var ye = ce('figure', 'figure').append(F(ue, 'image')),
                  ne = ce('frame').append(ye),
                  g = ce('view')
                    .prop('tabIndex', 0)
                ...
                (v.html &&
                  ...
                  ye.append(F(W, 'embed'))),
                  v.caption &&
                    ye.append(ce('caption', 'figcaption').text(v.caption)),
                  f.spinner.before(g),
                  Y || k());
                function k() {
                  if (
                  ...
                  let ve = NW(p, d);
                  (Z(f.arrowLeft, 'inactive', ve),
                    fe(f.arrowLeft, ve),
                    ve && f.arrowLeft.is(':focus') && f.arrowRight.focus());
                  let Fe = qW(p, d);
                  if (
                    (Z(f.arrowRight, 'inactive', Fe),
                    fe(f.arrowRight, Fe),
                    Fe && f.arrowRight.is(':focus') && f.arrowLeft.focus(),
                    f.view
                      ? (o(f.view)
                          .add('opacity .3s')
                          .start({ opacity: 0 })
                    ...
                    var Be = f.items.eq(p);
                    (F(Be, 'active'), Be.attr('aria-selected', !0), N(Be));
                  }
                }
              }),
        ...
        (I.hide = function () {
          return (
            o(f.lightbox).add('opacity .3s').start({ opacity: 0 }).then(z),
            I
          );
        }),
        (I.prev = function () {
      ...
      var C = O(I.prev),
        ...
        A = function (p) {
          var v = r(this).index();
          (p.preventDefault(), I.show(v));
        },
        X = function (p, v) {
          (p.preventDefault(),
            v.direction === 'left'
              ? I.next()
              : v.direction === 'right' && I.prev());
        },
        V = function () {
          this.focus();
        };
      ...
      function N(p) {
        var v = p.get(0),
          ...
          ne;
        (Q < he
          ? (ne = Math.max(0, Q + re - ue))
          : Q + re > ue + he && (ne = Math.min(Q, ye)),
          ne != null &&
            o(f.strip).add('scroll-left 500ms').start({ 'scroll-left': ne }));
      }
      function h(p, v, y) {
        ((this.$element = p),
          (this.className = v),
      ...
      function Z(p, v, y) {
        return p.toggleClass(P(v), y);
      }
      function fe(p, v) {
        return p.attr('aria-hidden', v).attr('tabIndex', v ? -1 : 0);
      }
      function ce(p, v) {
        return F(r(t.createElement(v || 'div')), p);
      }
      function _(p, v) {
        var y =
      ...
      return (
        (function () {
          ...
          (t.head.appendChild(re), e.addEventListener('resize', he, !0));
          function he() {
            var ue = e.innerHeight,
              ye = e.innerWidth,
              ne =
          ...
          webflowLightBox: function () {
            ...
            e.each(E, function (I, O) {
              ...
              (C ||
                ...
                m(C),
                a
                  ? C.el.on('setting' + s, m.bind(null, C))
                  : C.el.on('click' + s, f(C)).on('click' + s, function (R) {
                      R.preventDefault();
                    }));
            });
          },
          ...
          (T(I),
            ...
            O
              ? ((C = c[O]),
                ...
                (E.items = C),
                I.items.length &&
                  ((E.index = C.length), C.push.apply(C, I.items)))
      ...
      (gm.exports = function (e, t) {
        ...
        function z(g, W) {
          ...
          (ve &&
            ...
            h(k),
            d
              ? (U(k), k.el.on('setting' + E, P(k)))
              : (N(k),
                k.button.on('click' + E, fe(k)),
                k.menu.on('click' + E, 'a', ce(k)),
                k.button.on('keydown' + E, S(k)),
                k.el.on('keydown' + E, F(k))),
            v(g, W));
        }
        function te(g, W) {
          var Y = e.data(W, E);
          Y && (U(Y), e.removeData(W, E));
        }
        function U(g) {
          g.overlay && (ne(g, !0), g.overlay.remove(), (g.overlay = null));
        }
        function N(g) {
          g.overlay ||
        ...
        function h(g) {
          var W = {},
            Y = g.config || {},
            k = (W.animation = g.el.attr('data-animation') || 'default');
          ((W.animOver = /^over/.test(k)),
            (W.animDirect = /left$/.test(k) ? -1 : 1),
            Y.animation !== k && g.open && t.defer(Z, g),
        ...
        function S(g) {
          return function (W) {
            switch (W.keyCode) {
              case Me.SPACE:
              case Me.ENTER:
                return (fe(g)(), W.preventDefault(), W.stopPropagation());
              case Me.ESCAPE:
                return (ne(g), W.preventDefault(), W.stopPropagation());
              case Me.ARROW_RIGHT:
              case Me.ARROW_DOWN:
              case Me.HOME:
              case Me.END:
        ...
        function _(g) {
          return (
            ...
            function (W) {
              var Y = e(W.target);
              (m && Y.closest('.w-editor-bem-EditorOverlay').length) || p(g, Y);
            }
          );
        }
        var p = a(function (g, W) {
          if (g.open) {
            var Y = W.closest('.w-nav-menu');
            g.menu.is(Y) || ne(g);
          }
        });
        function v(g, W) {
          ...
          if ((Y.open && !k && !d && ne(Y, !0), Y.container.length)) {
            var ve = Q(Y);
        ...
        var y = 'max-width';
        function Q(g) {
          var W = g.container.css(y);
          return (
            W === 'none' && (W = ''),
            function (Y, k) {
              ((k = e(k)), k.css(y, ''), k.css(y) === 'none' && k.css(y, W));
            }
          );
        }
        function re(g, W) {
        ...
        function ue(g, W) {
          ...
          ((g.open = !0),
            ...
            g.dropdownList.addClass(R),
            g.button.addClass(I));
          var Y = g.config,
            k = Y.animation;
          (k === 'none' || !n.support.transform || Y.duration <= 0) && (W = !0);
          var ve = ye(g),
          ...
          if (
            ...
            (n(g.menu)
              .add(w)
              .set({ x: Y.animDirect * Be, height: ve })
              .start({ x: 0 })
              .then(D),
              g.overlay && g.overlay.width(Be));
            return;
          }
          var x = l + Fe;
          n(g.menu).add(w).set({ y: -x }).start({ y: 0 }).then(D);
          function D() {
        ...
        function ye(g) {
          var W = g.config,
            Y = W.docHeight ? i.height() : s.height();
          return (
            W.animOver
              ? g.menu.height(Y)
              : g.el.css('position') !== 'fixed' && (Y -= g.el.outerHeight(!0)),
        ...
        function ne(g, W) {
          ...
          var l = Be + ve;
          n(g.menu).add(k).start({ y: -l }).then(b);
          function b() {
            (g.menu.height(''),
    ...
    Dt.define(
      ...
      (ym.exports = function (e, t) {
        ...
        ((r.ready = function () {
          ...
          (r.destroy = C));
        function O() {
          ((i = o.find(c)), i.length && (i.each(A), !E && (C(), R())));
        }
        function C() {
        ...
        function A(_, p) {
          ...
          (y ||
            ...
            (y.mask = v.children('.w-slider-mask')),
            (y.left = v.children('.w-slider-arrow-left')),
            (y.right = v.children('.w-slider-arrow-right')),
            (y.nav = v.children('.w-slider-nav')),
            (y.slides = y.mask.children('.w-slide')),
            y.slides.each(T.reset),
            I && (y.maskWidth = 0),
            v.attr('role') === void 0 && v.attr('role', 'region'),
            v.attr('aria-label') === void 0 &&
              v.attr('aria-label', 'carousel'));
          var Q = y.mask.attr('id');
          if (
            (Q || ((Q = 'w-slider-mask-' + _), y.mask.attr('id', Q)),
            !a && !y.ariaLiveLabel && (y.ariaLiveLabel = e(m).appendTo(y.mask)),
            y.left.attr('role', 'button'),
            y.left.attr('tabindex', '0'),
            y.left.attr('aria-controls', Q),
            y.left.attr('aria-label') === void 0 &&
              y.left.attr('aria-label', 'previous slide'),
            y.right.attr('role', 'button'),
            y.right.attr('tabindex', '0'),
            y.right.attr('aria-controls', Q),
          ...
          (y.el.off(c),
            ...
            X(y),
            a
              ? (y.el.on('setting' + c, h(y)), N(y), (y.hasTimer = !1))
              : (y.el.on('swipe' + c, h(y)),
                y.left.on('click' + c, K(y)),
                y.right.on('click' + c, z(y)),
                y.left.on('keydown' + c, B(y, K)),
                y.right.on('keydown' + c, B(y, z)),
                y.nav.on('keydown' + c, '> div', h(y)),
                y.config.autoplay &&
                  !y.hasTimer &&
                  ((y.hasTimer = !0), (y.timerCount = 1), U(y)),
                y.el.on('mouseenter' + c, G(y, !0, 'mouse')),
                y.el.on('focusin' + c, G(y, !0, 'keyboard')),
                y.el.on('mouseleave' + c, G(y, !1, 'mouse')),
                y.el.on('focusout' + c, G(y, !1, 'keyboard'))),
            y.nav.on('click' + c, '> div', h(y)),
            s ||
              y.mask
                .contents()
                .filter(function () {
                ...
                .remove());
          var re = v.filter(':hidden');
          re.addClass(f);
          var he = v.parents(':hidden');
          (he.addClass(f), I || F(_, p), re.removeClass(f), he.removeClass(f));
        }
        function X(_) {
          var p = {};
          ((p.crossOver = 0),
            (p.animation = _.el.attr('data-animation') || 'slide'),
            p.animation === 'outin' &&
              ((p.animation = 'cross'), (p.crossOver = 0.5)),
            (p.easing = _.el.attr('data-easing') || 'ease'));
          var v = _.el.attr('data-duration');
          if (
            ((p.duration = v != null ? parseInt(v, 10) : 500),
            V(_.el.attr('data-infinite')) && (p.infinite = !0),
            V(_.el.attr('data-disable-swipe')) && (p.disableSwipe = !0),
            V(_.el.attr('data-hide-arrows'))
              ? (p.hideArrows = !0)
              : _.config.hideArrows && (_.left.show(), _.right.show()),
            V(_.el.attr('data-autoplay')))
          ) {
            ((p.autoplay = !0),
              (p.delay = parseInt(_.el.attr('data-delay'), 10) || 2e3),
              (p.timerMax = parseInt(_.el.attr('data-autoplay-limit'), 10)));
            var y = 'mousedown' + c + ' touchstart' + c;
            a ||
              _.el.off(y).one(y, function () {
                N(_);
              });
          }
          var Q = _.right.width();
          ((p.edge = Q ? Q + 40 : 100), (_.config = p));
        }
        function V(_) {
          return _ === '1' || _ === 'true';
        }
        function G(_, p, v) {
          return function (y) {
            if (p) _.hasFocus[v] = p;
              ...
              e.contains(_.el.get(0), y.relatedTarget) ||
              ((_.hasFocus[v] = p),
              (_.hasFocus.mouse && v === 'keyboard') ||
                (_.hasFocus.keyboard && v === 'mouse'))
            )
              return;
            p
              ? (_.ariaLiveLabel.attr('aria-live', 'polite'),
                _.hasTimer && N(_))
              : (_.ariaLiveLabel.attr('aria-live', 'off'), _.hasTimer && U(_));
          };
        }
        function B(_, p) {
          return function (v) {
            switch (v.keyCode) {
              case _t.SPACE:
              case _t.ENTER:
                return (p(_)(), v.preventDefault(), v.stopPropagation());
            }
          };
        }
        function K(_) {
          return function () {
            S(_, { index: _.index - 1, vector: -1 });
          };
        }
        function z(_) {
          return function () {
        ...
        function te(_, p) {
          var v = null;
          (p === _.slides.length && (O(), j(_)),
            t.each(_.anchors, function (y, Q) {
              e(y.els).each(function (re, he) {
                e(he).index() === p && (v = Q);
              });
            }),
            v != null && S(_, { index: v, immediate: !0 }));
        }
        function U(_) {
          N(_);
          var p = _.config,
            v = p.timerMax;
          (v && _.timerCount++ > v) ||
            (_.timerId = window.setTimeout(function () {
              _.timerId == null || a || (z(_)(), U(_));
            }, p.delay));
        }
        function N(_) {
          (window.clearTimeout(_.timerId), (_.timerId = null));
        }
        function h(_) {
          return function (p, v) {
            v = v || {};
            var y = _.config;
            if (a && p.type === 'setting') {
              if (v.select === 'prev') return K(_)();
              if (v.select === 'next') return z(_)();
              if ((X(_), j(_), v.select == null)) return;
              te(_, v.select);
              return;
            }
            if (p.type === 'swipe')
              return y.disableSwipe || Dt.env('editor')
                ? void 0
                : v.direction === 'left'
                  ? z(_)()
                  : v.direction === 'right'
                    ? K(_)()
                    : void 0;
            if (_.nav.has(p.target).length) {
              var Q = e(p.target).index();
              if (
                (p.type === 'click' && S(_, { index: Q }), p.type === 'keydown')
              )
                switch (p.keyCode) {
                  case _t.ENTER:
                  case _t.SPACE: {
                    (S(_, { index: Q }), p.preventDefault());
                    break;
                  }
                  case _t.ARROW_LEFT:
                  case _t.ARROW_UP: {
                    (P(_.nav, Math.max(Q - 1, 0)), p.preventDefault());
                    break;
                  }
                  case _t.ARROW_RIGHT:
                  case _t.ARROW_DOWN: {
                    (P(_.nav, Math.min(Q + 1, _.pages)), p.preventDefault());
                    break;
                  }
                  case _t.HOME: {
                    (P(_.nav, 0), p.preventDefault());
                    break;
                  }
                  case _t.END: {
                    (P(_.nav, _.pages), p.preventDefault());
                    break;
                  }
                  default:
                    return;
        ...
        function S(_, p) {
          ...
          (Q < 0
            ? ((Q = y.length - 1),
              v.infinite &&
                ((re.x = -_.endX), (re.from = 0), (re.to = y[0].width)))
            : Q >= y.length &&
              ((Q = 0),
              v.infinite &&
                ((re.x = y[y.length - 1].width),
                (re.from = -y[y.length - 1].x),
                (re.to = re.from - re.x))),
            (_.index = Q));
          var he = _.nav
            .children()
          ...
          (_.nav
            ...
            .attr('tabindex', '-1'),
            v.hideArrows &&
              (_.index === y.length - 1 ? _.right.hide() : _.right.show(),
              _.index === 0 ? _.left.hide() : _.left.show()));
          var ue = _.offsetX || 0,
            ye = (_.offsetX = -y[_.index].x),
            ne = { x: ye, opacity: 1, visibility: '' },
            g = e(y[_.index].els),
            W = e(y[_.previous] && y[_.previous].els),
            Y = _.slides.not(g),
            k = v.animation,
            ve = v.easing,
            Fe = Math.round(v.duration),
            Be = p.vector || (_.index > _.previous ? 1 : -1),
            l = 'opacity ' + Fe + 'ms ' + ve,
            b = 'transform ' + Fe + 'ms ' + ve;
          if (
            (g.find(_m).removeAttr('tabindex'),
            g.removeAttr('aria-hidden'),
            g.find('*').removeAttr('aria-hidden'),
            Y.find(_m).attr('tabindex', '-1'),
            Y.attr('aria-hidden', 'true'),
            Y.find('*').attr('aria-hidden', 'true'),
            a || (g.each(T.intro), Y.each(T.outro)),
            p.immediate && !I)
          ) {
            (n(g).set(ne), D());
            return;
          ...
          if (
            (a || _.ariaLiveLabel.text(`Slide ${Q + 1} of ${y.length}.`),
            k === 'cross')
          ) {
            var w = Math.round(Fe - Fe * v.crossOver),
              x = Math.round(Fe - w);
            ((l = 'opacity ' + w + 'ms ' + ve),
              n(W).set({ visibility: '' }).add(l).start({ opacity: 0 }),
              n(g)
                .set({ visibility: '', x: ye, opacity: 0, zIndex: _.depth++ })
                .add(l)
                .wait(x)
                .then({ opacity: 1 })
                .then(D));
          ...
          v.infinite && re.x
            ...
            : (v.infinite &&
                _.shifted &&
                (n(_.shifted).set({ visibility: '', x: ue }),
                (_.shifted = null)),
              n(_.slides).set({ visibility: '' }).add(b).start({ x: ye }));
          function D() {
            ((g = e(y[_.index].els)),
              (Y = _.slides.not(g)),
              k !== 'slide' && (ne.visibility = 'hidden'),
              n(Y).set(ne));
          }
        }
        function F(_, p) {
        ...
        function j(_) {
          var p = 1,
            ...
            he = re - _.config.edge;
          (he < 0 && (he = 0),
            (_.anchors = [{ els: [], x: 0, width: 0 }]),
            _.slides.each(function (ye, ne) {
              (y - v > he &&
                (p++,
                (v += re),
                (_.anchors[p - 1] = { els: [], x: y, width: 0 })),
                (Q = e(ne).outerWidth(!0)),
                (y += Q),
                (_.anchors[p - 1].width += Q),
                _.anchors[p - 1].els.push(ne));
              var g = ye + 1 + ' of ' + _.slides.length;
              (e(ne).attr('aria-label', g), e(ne).attr('role', 'group'));
            }),
            (_.endX = y),
            a && (_.pages = null),
            _.nav.length && _.pages !== p && ((_.pages = p), Z(_)));
          var ue = _.index;
          (ue >= p && (ue = p - 1), S(_, { immediate: !0, index: ue }));
        }
        function Z(_) {
          var p = [],
            v,
            y = _.el.attr('data-nav-spacing');
          y && (y = parseFloat(y) + 'px');
          for (var Q = 0, re = _.pages; Q < re; Q++)
            ((v = e(d)),
              v
                .attr('aria-label', 'Show slide ' + (Q + 1) + ' of ' + re)
                .attr('aria-pressed', 'false')
                .attr('role', 'button')
                .attr('tabindex', '-1'),
              _.nav.hasClass('w-num') && v.text(Q + 1),
              y != null && v.css({ 'margin-left': y, 'margin-right': y }),
              p.push(v));
          _.nav.empty().append(p);
        }
        function fe(_) {
          var p = _.mask.width();
          return _.maskWidth !== p ? ((_.maskWidth = p), !0) : !1;
        }
        function ce(_) {
          var p = 0;
          return (
            _.slides.each(function (v, y) {
              p += e(y).outerWidth(!0);
            }),
            _.slidesWidth !== p ? ((_.slidesWidth = p), !0) : !1
          );
        }
        return r;
      })
    ...
    Mt.define(
      ...
      (Im.exports = function (e) {
        ...
        ((t.ready = t.design = t.preview = C),
          ...
          (t.destroy = function () {
            ((o = n.find(f)), o.length && (o.each(A), R()));
          }));
        function C() {
          ((i = c && Mt.env('design')),
            (o = n.find(f)),
            o.length &&
              (o.each(X), Mt.env('preview') && !O && o.each(A), R(), q()));
        }
        function R() {
        ...
        function X(U, N) {
          var h = f.substr(1) + '-' + U,
            ...
            S = e.data(N, f);
          if (
            (S || (S = e.data(N, f, { el: P, config: {} })),
            (S.current = null),
            (S.tabIdentifier = h + '-' + d),
            (S.paneIdentifier = h + '-' + m),
            (S.menu = P.children('.w-tab-menu')),
            (S.links = S.menu.children('.w-tab-link')),
            (S.content = P.children('.w-tab-content')),
            ...
            (S.links.on('click' + f, B(S)), S.links.on('keydown' + f, K(S)));
            var F = S.links.filter('.' + T),
              j = F.attr(d);
            j && z(S, { tab: j, immediate: !0 });
          }
        }
        function V(U) {
          var N = {};
          N.easing = U.el.attr('data-easing') || 'ease';
          var h = parseInt(U.el.attr('data-duration-in'), 10);
          h = N.intro = h === h ? h : 0;
        ...
        function z(U, N) {
          ...
          if (S !== U.current) {
            U.current = S;
            var F;
            U.links.each(function (v, y) {
              var Q = e(y);
              if (N.immediate || h.immediate) {
                var re = U.panes[v];
                (y.id || (y.id = U.tabIdentifier + '-' + v),
                  re.id || (re.id = U.paneIdentifier + '-' + v),
                  (y.href = '#' + re.id),
                  y.setAttribute('role', 'tab'),
                  y.setAttribute('aria-controls', re.id),
                  y.setAttribute('aria-selected', 'false'),
                  re.setAttribute('role', 'tabpanel'),
                  re.setAttribute('aria-labelledby', y.id));
              }
              y.getAttribute(d) === S
                ? ((F = y),
                  Q.addClass(T)
            ...
            var j = [],
              Z = [];
            U.panes.each(function (v, y) {
              var Q = e(y);
              y.getAttribute(d) === S ? j.push(y) : Q.hasClass(E) && Z.push(y);
            });
            var fe = e(j),
              ce = e(Z);
            if (N.immediate || h.immediate) {
              (fe.addClass(E).each(I.intro),
                ce.removeClass(E),
                O || Mt.redraw.up());
              return;
            } else {
...
Webflow.require('ix2').init({
  events: {
    'e-7': {
      ...
      target: {
        id: '647707b035f159fa24a28250|11f91085-b954-6a5d-ed23-cd316be48172',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-9': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|a77dd96f-5781-eafd-e8db-8a7d9c999a40',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-15': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|78b99b73-c6ef-90cd-c3ea-4c8edddd2db9',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-18': {
      ...
      target: {
        ...
        originalId: '9e32eb74-fa90-dbad-c175-bf0e211fb9c4',
        appliesTo: 'CLASS',
      },
      targets: [
        {
          id: '9e32eb74-fa90-dbad-c175-bf0e211fb9c4',
          appliesTo: 'ELEMENT',
          styleBlockIds: [],
        },
      ],
    ...
    'e-30': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|da418097-8d09-1b20-cc07-115e82d41e29',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-33': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|c08a3577-eecc-d961-2d7e-894c7765e450',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-51': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '647707b035f159fa24a28250|3af7aa85-9611-a05a-2192-af68a59739f9',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-53': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '647707b035f159fa24a28250|3af7aa85-9611-a05a-2192-af68a5973a00',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-55': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '647707b035f159fa24a28250|ea331ec9-1e89-f9e3-e4e6-a83903338807',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-57': {
      ...
      mediaQueries: ['main', 'medium'],
      target: {
        id: '647707b035f159fa24a28250|3af7aa85-9611-a05a-2192-af68a5973a05',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-71': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6488afc9b6cd4d2bfa0ad591|dd5da92d-aa51-b8de-0b70-316c31d5f20e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-73': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6488afc9b6cd4d2bfa0ad591|8ce7a1a5-c1e9-5360-7c69-ccde962bc2f0',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-82': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64a4351ae788eeac7506a0d7|04600be4-bb09-5ab3-3d4c-52fa579b10b6',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-84': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64a4351ae788eeac7506a0d7|cec35437-ef3a-579e-c118-20e5fea61f57',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-242': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|ccfe9a73-f079-c4f3-52fe-43f1f1b88e8d',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-244': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f731',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-246': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f73a',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-254': {
      ...
      target: {
        selector: '.tabpane',
        originalId:
          '647707b035f159fa24a28250|630d7107-0bd0-6393-0259-992c90323c5b',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-256': {
      ...
      target: {
        selector: '.tablink._2',
        originalId:
          '647707b035f159fa24a28250|630d7107-0bd0-6393-0259-992c90323c51',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-258': {
      ...
      target: {
        selector: '.tablink._2',
        originalId:
          '647707b035f159fa24a28250|630d7107-0bd0-6393-0259-992c90323c54',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-266': {
      ...
      target: {
        selector: '.tablink',
        originalId:
          '647707b035f159fa24a28250|a5acfb4d-5968-53c3-4425-61772f7c2342',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-270': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f726',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-272': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f730',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-274': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f739',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-276': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|8e79c093-2a7f-ada9-41a4-37c33d58f742',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-280': {
      ...
      action: {
        ...
        actionTypeId: 'FADE_EFFECT',
        instant: false,
        config: { actionListId: 'fadeIn', autoStopEventId: 'e-281' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|4c5b447c-2374-b2e7-975d-04850c1d8fd1',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-282': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|b519719d-8a3d-669d-48c7-66ab912a49ce',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-283': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|da418097-8d09-1b20-cc07-115e82d41e27',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-287': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|5704e731-b09a-16dd-45ea-9bad52f4be21',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-291': {
      ...
      action: {
        ...
        actionTypeId: 'GROW_EFFECT',
        instant: false,
        config: { actionListId: 'growIn', autoStopEventId: 'e-292' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|ea955757-cef0-5b2d-8875-1e402e125f61',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-299': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce54e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-301': {
      ...
      action: {
        ...
        actionTypeId: 'SLIDE_EFFECT',
        instant: false,
        config: { actionListId: 'slideInLeft', autoStopEventId: 'e-302' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce55b',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-305': {
      ...
      action: {
        ...
        instant: false,
        config: { actionListId: 'pop', autoStopEventId: 'e-306' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|45f32957-713f-e1ce-ebca-82a9356c23b5',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-309': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|2771a231-3700-97b4-fe34-5be01684c885',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-310': {
      ...
      action: {
        ...
        actionTypeId: 'GROW_EFFECT',
        instant: false,
        config: { actionListId: 'growIn', autoStopEventId: 'e-311' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|def593b1-94be-f736-d28f-988a3641fd7b',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-324': {
      ...
      target: {
        selector: '.tablink',
        originalId:
          '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce555',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-330': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce552',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-332': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce555',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-334': {
      ...
      action: {
        ...
        actionTypeId: 'SLIDE_EFFECT',
        instant: false,
        config: { actionListId: 'slideInLeft', autoStopEventId: 'e-335' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce558',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-380': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae794e1bf95b86d9c3d3c9|c06f2cfb-a143-f74e-62a2-fd4dcad56a40',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-386': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae791aaef577f819245175|e717cba6-a226-e3c6-ec4c-b067d0fd0a2c',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-388': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce546',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-390': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '647707b035f159fa24a28250|45f32957-713f-e1ce-ebca-82a9356c23b7',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-396': {
      ...
      target: {
        selector: '.tiletitle',
        originalId:
          '64ae791aaef577f819245175|e717cba6-a226-e3c6-ec4c-b067d0fd09c4',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-398': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.navbutton.light',
        originalId: '5ae6cc6c-b4b2-e34e-1a76-ad3c64e62845',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-400': {
      ...
      target: {
        selector: '.logo',
        originalId: '5ae6cc6c-b4b2-e34e-1a76-ad3c64e62840',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-402': {
      ...
      target: {
        selector: '.link',
        originalId:
          '64ae791aaef577f819245175|1964304f-cc3c-175b-6e28-4f0f3991316b',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-404': {
      ...
      target: {
        selector: '.arrowwrap',
        originalId:
          '64ae791aaef577f819245175|e717cba6-a226-e3c6-ec4c-b067d0fd0a3c',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-408': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64a4351ae788eeac7506a0d7|9b20aadf-abc4-6e0b-0b3d-fc1f1a37acf3',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-410': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae791aaef577f819245175|399f8c70-2d37-3d98-b2fe-2c57e33215dd',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-412': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae791aaef577f819245175|399f8c70-2d37-3d98-b2fe-2c57e33215de',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-414': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae791aaef577f819245175|399f8c70-2d37-3d98-b2fe-2c57e33215e4',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-416': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae79319f89d24c769706b7|1a29a88e-b7e8-0164-3fdb-87f2d0214083',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-418': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae79319f89d24c769706b7|1a29a88e-b7e8-0164-3fdb-87f2d0214084',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-420': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae79319f89d24c769706b7|1a29a88e-b7e8-0164-3fdb-87f2d021408a',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-422': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae794e1bf95b86d9c3d3c9|d07543e4-f4dd-f1b7-b5d1-c3480e53a62e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-424': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae794e1bf95b86d9c3d3c9|d07543e4-f4dd-f1b7-b5d1-c3480e53a62f',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-426': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64ae794e1bf95b86d9c3d3c9|d07543e4-f4dd-f1b7-b5d1-c3480e53a635',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-435': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '647707b035f159fa24a28250|f48a2ca4-7775-e79e-1709-0f9c0e85b706',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-437': {
      ...
      target: {
        selector: '.navlink',
        originalId:
          '647707b035f159fa24a28250|f48a2ca4-7775-e79e-1709-0f9c0e85b704',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-441': {
      ...
      target: {
        selector: '.tablink',
        originalId:
          '647707b035f159fa24a28250|468f9dcf-91d3-7005-081c-2394f6fce558',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-443': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '647707b035f159fa24a28250|654ff96d-1b7a-f63e-d61e-a67ba1de3ec0',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-445': {
      ...
      target: {
        selector: '.video',
        originalId:
          '64ae79319f89d24c769706b7|29da49cb-c971-32a2-3797-73e93e8ad706',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-455': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|2771a231-3700-97b4-fe34-5be01684c87a',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-458': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '647707b035f159fa24a28250|f48a2ca4-7775-e79e-1709-0f9c0e85b6f7',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.hovercover',
                  selectorGuids: ['efc59e0b-a3b2-21cc-8e1e-7a0783676852'],
                },
                yValue: -276,
                xUnit: 'PX',
                yUnit: 'px',
    ...
    'a-11': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.cursortag',
                      selectorGuids: ['bbba04da-6a1c-c258-3c4e-1f4f981c9e1c'],
                    },
                    xValue: -20,
                    xUnit: 'px',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.heroimage',
                      selectorGuids: ['14bcbec6-459d-64c9-8a8f-acf0f07532e7'],
                    },
                    xValue: -4,
                    xUnit: 'px',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.logointeraction',
                      selectorGuids: ['476cc1ca-d756-3615-d094-eafdfcd0da20'],
                    },
                    xValue: -28,
                    xUnit: 'px',
                    yUnit: 'PX',
      ...
      createdOn: 1685540736851,
    },
    'a-5': {
      id: 'a-5',
      title: 'Card Mouseover',
      continuousParameterGroups: [
        {
          id: 'a-5-p',
          type: 'MOUSE_X',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      id: '647707b035f159fa24a28250|b4d807c0-0806-65e1-494c-de10dedd348b',
                    },
                    xValue: 0.8,
                    yValue: 0.8,
                    locked: true,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      id: '647707b035f159fa24a28250|9c5f4dd5-a5b2-de5f-be51-92fd6a34ef3b',
                    },
                    xValue: 0.2,
                    yValue: 0.2,
                    locked: true,
    ...
    'a-13': {
      ...
      createdOn: 1685614936418,
    },
    'a-4': {
      id: 'a-4',
      title: 'About Me Reveal',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 200,
                target: {
                  selector: '.float.image',
                  selectorGuids: [
                    'c8fd9b34-1454-d88e-e757-27460ad03524',
                    'a2f4d697-bf38-a7ab-0a9b-d8c289ad6c9f',
                  ],
                },
                yValue: 324,
                zValue: null,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.texthover',
                  selectorGuids: ['e03cf9d9-5b53-8a5a-2839-fdea7356de97'],
                },
                globalSwatchId: '35d4c0ea',
                rValue: 11,
                bValue: 53,
                gValue: 11,
                aValue: 1,
    ...
    'a-15': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.h3_hover',
                  selectorGuids: ['1aa830bd-553d-39f0-1287-a248f1a902b8'],
                },
                yValue: 0,
                xUnit: 'PX',
                yUnit: 'px',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.h3_hoverhidden',
                  selectorGuids: ['b59747df-3738-1a1d-b6c9-1f5533d454ec'],
                },
                yValue: 0,
                xUnit: 'PX',
                yUnit: 'px',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1685632981507,
    },
    'a-16': {
      id: 'a-16',
      title: 'Heading Hover Out',
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.hovercover.backgroundinvert',
                  selectorGuids: [
                    'efc59e0b-a3b2-21cc-8e1e-7a0783676852',
                    'e88f43ea-8b78-a90b-a803-b195a6c5ed1b',
                  ],
                },
                yValue: -340,
                xUnit: 'PX',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: '647707b035f159fa24a28250|a5acfb4d-5968-53c3-4425-61772f7c2342',
                },
                xValue: 1.05,
                yValue: 1.05,
                locked: true,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: '647707b035f159fa24a28250|a5acfb4d-5968-53c3-4425-61772f7c2348',
                },
                xValue: 1,
                yValue: 1,
                locked: true,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: '.navlink',
                      selectorGuids: ['17ecd846-7488-f0af-d817-aa16660034fc'],
                    },
                    globalSwatchId: '3582b14a',
                    rValue: 250,
                    bValue: 250,
                    gValue: 250,
                    aValue: 1,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: '.logo',
                      selectorGuids: ['7f516adb-fae7-03de-8749-170c48b82964'],
                    },
                    globalSwatchId: '36ec9eee',
                    rValue: 230,
                    bValue: 70,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: '.navbutton',
                      selectorGuids: ['9fa4d4a3-bb71-5505-5820-b7b624653e23'],
                    },
                    globalSwatchId: '3582b14a',
                    rValue: 250,
                    bValue: 250,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.navbar',
                  selectorGuids: ['c8d33ad2-38c8-2337-7568-df39f02a379c'],
                },
                yValue: 0,
                xUnit: 'PX',
                yUnit: 'px',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.icon',
                  selectorGuids: ['bb537651-e820-334e-8b50-ba12f7ff2efa'],
                },
                yValue: null,
                zValue: 0,
                xUnit: 'DEG',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      id: '647707b035f159fa24a28250|78c3f8b7-2384-9fe1-ce9e-085c2a2a2902',
                    },
                    xValue: null,
                    yValue: -19,
                    xUnit: 'deg',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      id: '647707b035f159fa24a28250|07eb441e-5220-1180-a343-4f3206919d51',
                    },
                    xValue: null,
                    yValue: -27,
                    zValue: 0,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.label.text_light',
                  selectorGuids: [
                    '55e078b6-9ba9-9b6f-8ca4-14d89338a9d3',
                    'e85e3f0a-cc74-47c9-914a-a4f2d39a15ee',
                  ],
                },
                yValue: 0,
                xUnit: 'PX',
    ...
    'a-24': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.arrowwrap',
                  selectorGuids: ['b604c61f-95a9-fe6b-20a3-4a980e7323d6'],
                },
                value: 0,
                unit: '',
              },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1688752838292,
    },
    'a-25': {
      id: 'a-25',
      title: 'Gallery Arrow Off',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    easing: '',
                    duration: 500,
                    target: { id: 'b10820f5-106e-b8a6-cc71-2751d585c588' },
                    xValue: -50,
                    xUnit: 'vw',
                    yUnit: 'PX',
                    zUnit: 'PX',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.innerdot',
                  selectorGuids: ['8416eef6-7638-08ef-43b9-a42a99f5f0d1'],
                },
                widthValue: 50,
                heightValue: 50,
                widthUnit: 'px',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['8416eef6-7638-08ef-43b9-a42a99f5f0d2'],
                },
                widthValue: 50,
                heightValue: 50,
                widthUnit: 'px',
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: '.tooltiplabel',
                  selectorGuids: ['a6ee16e8-ab56-e52c-8227-9ff02bf43409'],
                },
                value: 'block',
              },
            },
    ...
    'a-47': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 50000,
                target: {
                  id: '647707b035f159fa24a28250|00ae4384-53c2-3628-9568-94ba383649cd',
                },
                zValue: 360,
                xUnit: 'DEG',
                yUnit: 'DEG',
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1690974022430,
    },
    'a-48': {
      id: 'a-48',
      title: 'Stamp Rotate Stop',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-50': {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1690980392680,
    },
    'a-51': {
      id: 'a-51',
      title: 'Emenin Hover Out',
      actionItemGroups: [
        {
          actionItems: [
            {
