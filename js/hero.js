// Hero: a loading state on the hero's own source, the design tokens behind each
// piece on hover, and "a new reader" decoding like a machine reading it.
// The pointer glow lives in components.js ([data-glow]).
(function () {
  'use strict';
  ...
  // ---- Decode ------------------------------------------------------------------
  // Each letter flickers through glyphs and settles, left to right: once when the
  // hero resolves, and again when the phrase is hovered.
  var phrase = inner.querySelector('.hero-headline-em');
  var decode = function () {};
